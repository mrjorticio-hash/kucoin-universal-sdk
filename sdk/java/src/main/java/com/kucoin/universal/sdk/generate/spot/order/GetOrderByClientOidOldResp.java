...
public class GetOrderByClientOidOldResp
    implements Response<GetOrderByClientOidOldResp, RestResponse<GetOrderByClientOidOldResp>> {
  /** */
  @JsonProperty("id")
  private String id;
  ...
  /** common response */
  @JsonIgnore private RestResponse<GetOrderByClientOidOldResp> commonResponse;

  @Override
  public void setCommonResponse(RestResponse<GetOrderByClientOidOldResp> response) {
