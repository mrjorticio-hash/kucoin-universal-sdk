...
class SpotPublicWsAutoGeneratedTest {
  public static ObjectMapper mapper = new ObjectMapper();

  private static final List<String> failedTests = new ArrayList<>();

  /** allTickers Get All Tickers /allTickers/market/ticker:all */
  public static void testAllTickersResponse() throws Exception {
    String data =
    ...
    AllTickersEvent event = mapper.convertValue(resp.getData(), AllTickersEvent.class);
  }

  /** callAuctionInfo Get Call Auction Info /callAuctionInfo/callauction/callauctionData:_symbol_ */
  public static void testCallAuctionInfoResponse() throws Exception {
    String data =
    ...
    WsMessage resp = mapper.readValue(data, WsMessage.class);
    CallAuctionInfoEvent event = mapper.convertValue(resp.getData(), CallAuctionInfoEvent.class);
  }
   ...
   */
  public static void testCallAuctionOrderbookLevel50Response() throws Exception {
    String data =
    ...
    CallAuctionOrderbookLevel50Event event =
        mapper.convertValue(resp.getData(), CallAuctionOrderbookLevel50Event.class);
  }
  ...
  public static void testKlinesResponse() throws Exception {
    ...
    WsMessage resp = mapper.readValue(data, WsMessage.class);
    KlinesEvent event = mapper.convertValue(resp.getData(), KlinesEvent.class);
  }

  /** marketSnapshot Market Snapshot /marketSnapshot/market/snapshot:_market_ */
  public static void testMarketSnapshotResponse() throws Exception {
    String data =
        "{\"topic\":\"/market/snapshot:BTC\",\"type\":\"message\",\"subject\":\"trade.snapshot\",\"data\":{\"sequence\":\"1729785948015\",\"data\":{\"askSize\":1375.1096,\"averagePrice\":0.00000262,\"baseCurrency\":\"CHR\",\"bidSize\":152.0912,\"board\":0,\"buy\":0.00000263,\"changePrice\":0.00000005300000000000,\"changeRate\":0.0200,\"close\":0.000002698,\"datetime\":1729785948008,\"high\":0.00000274600000000000,\"lastTradedPrice\":0.000002698,\"low\":0.00000255800000000000,\"makerCoefficient\":1.000000,\"makerFeeRate\":0.001,\"marginTrade\":false,\"mark\":0,\"market\":\"BTC\",\"marketChange1h\":{\"changePrice\":-0.00000000900000000000,\"changeRate\":-0.0033,\"high\":0.00000270700000000000,\"low\":0.00000264200000000000,\"open\":0.00000270700000000000,\"vol\":27.10350000000000000000,\"volValue\":0.00007185015660000000},\"marketChange24h\":{\"changePrice\":0.00000005300000000000,\"changeRate\":0.0200,\"high\":0.00000274600000000000,\"low\":0.00000255800000000000,\"open\":0.00000264500000000000,\"vol\":6824.94800000000000000000,\"volValue\":0.01789509649520000000},\"marketChange4h\":{\"changePrice\":0.00000000600000000000,\"changeRate\":0.0022,\"high\":0.00000270700000000000,\"low\":0.00000264200000000000,\"open\":0.00000269200000000000,\"vol\":92.69020000000000000000,\"volValue\":0.00024903875740000000},\"markets\":[\"BTC\",\"DePIN\",\"Layer"
            + " 1\"],\"open\":0.00000264500000000000,\"quoteCurrency\":\"BTC\",\"sell\":0.000002695,\"siteTypes\":[\"global\"],\"sort\":100,\"symbol\":\"CHR-BTC\",\"symbolCode\":\"CHR-BTC\",\"takerCoefficient\":1.000000,\"takerFeeRate\":0.001,\"trading\":true,\"vol\":6824.94800000000000000000,\"volValue\":0.01789509649520000000}}}";
    WsMessage resp = mapper.readValue(data, WsMessage.class);
    MarketSnapshotEvent event = mapper.convertValue(resp.getData(), MarketSnapshotEvent.class);
  }
  ...
  public static void testOrderbookIncrementResponse() throws Exception {
    ...
    OrderbookIncrementEvent event =
        mapper.convertValue(resp.getData(), OrderbookIncrementEvent.class);
  }

  /** orderbookLevel1 Orderbook - Level1 /orderbookLevel1/spotMarket/level1:_symbol_,_symbol_ */
  public static void testOrderbookLevel1Response() throws Exception {
    String data =
    ...
    WsMessage resp = mapper.readValue(data, WsMessage.class);
"0.05177498\"],[\"95942.3\",\"0.26028569\"],[\"95942.2\",\"0.10271829\"],[\"95940.6\",\"0.12531139\"],[\"95940.2\",\"0.43349327\"],[\"95938.3\",\"0.01041604\"],[\"95937.4\",\"0.04957577\"],[\"95937.2\",\"0.00305\"],[\"95936.3\",\"0.10271829\"],[\"95934\",\"0.05177498\"],[\"95931.9\",\"0.03394093\"],[\"95931.8\",\"0.10271829\"],[\"95930\",\"0.01041814\"],[\"95927.9\",\"0.10271829\"],[\"95927\",\"0.13312774\"],[\"95926.9\",\"0.33077498\"],[\"95924.9\",\"0.10271829\"],[\"95924\",\"0.00180915\"],[\"95923.8\",\"0.00022434\"],[\"95919.6\",\"0.00021854\"],[\"95919.1\",\"0.01471872\"],[\"95919\",\"0.05177498\"],[\"95918.1\",\"0.00001889\"],[\"95917.8\",\"0.1521089\"],[\"95917.5\",\"0.00010962\"],[\"95916.2\",\"0.00021958\"],[\"95915.5\",\"0.12531139\"],[\"95915.3\",\"0.279\"],[\"95913.6\",\"0.01739249\"],[\"95913.5\",\"0.05177498\"]],\"timestamp\":1733124805073}}";
    WsMessage resp = mapper.readValue(data, WsMessage.class);
    OrderbookLevel50Event event = mapper.convertValue(resp.getData(), OrderbookLevel50Event.class);
  }
  ...
  public static void testOrderbookLevel5Response() throws Exception {
    ...
    WsMessage resp = mapper.readValue(data, WsMessage.class);
    OrderbookLevel5Event event = mapper.convertValue(resp.getData(), OrderbookLevel5Event.class);
  }
  ...
  public static void testSymbolSnapshotResponse() throws Exception {
    ...
    WsMessage resp = mapper.readValue(data, WsMessage.class);
    SymbolSnapshotEvent event = mapper.convertValue(resp.getData(), SymbolSnapshotEvent.class);
  }

  /** ticker Get Ticker /ticker/market/ticker:_symbol_,_symbol_ */
  public static void testTickerResponse() throws Exception {
    String data =
    ...
    WsMessage resp = mapper.readValue(data, WsMessage.class);
    TickerEvent event = mapper.convertValue(resp.getData(), TickerEvent.class);
  }

  /** trade Trade /trade/market/match:_symbol_,_symbol_ */
  public static void testTradeResponse() throws Exception {
    String data =
    ...
    WsMessage resp = mapper.readValue(data, WsMessage.class);
    TradeEvent event = mapper.convertValue(resp.getData(), TradeEvent.class);
  }

  public static void runAllTests() {
    run(SpotPublicWsAutoGeneratedTest::testAllTickersResponse, "testAllTickersResponse");
    run(SpotPublicWsAutoGeneratedTest::testCallAuctionInfoResponse, "testCallAuctionInfoResponse");
    run(
        SpotPublicWsAutoGeneratedTest::testCallAuctionOrderbookLevel50Response,
        "testCallAuctionOrderbookLevel50Response");
    run(SpotPublicWsAutoGeneratedTest::testKlinesResponse, "testKlinesResponse");
    run(SpotPublicWsAutoGeneratedTest::testMarketSnapshotResponse, "testMarketSnapshotResponse");
    run(
        SpotPublicWsAutoGeneratedTest::testOrderbookIncrementResponse,
        "testOrderbookIncrementResponse");
    run(SpotPublicWsAutoGeneratedTest::testOrderbookLevel1Response, "testOrderbookLevel1Response");
    run(
        SpotPublicWsAutoGeneratedTest::testOrderbookLevel50Response,
        "testOrderbookLevel50Response");
    run(SpotPublicWsAutoGeneratedTest::testOrderbookLevel5Response, "testOrderbookLevel5Response");
    run(SpotPublicWsAutoGeneratedTest::testSymbolSnapshotResponse, "testSymbolSnapshotResponse");
    run(SpotPublicWsAutoGeneratedTest::testTickerResponse, "testTickerResponse");
    run(SpotPublicWsAutoGeneratedTest::testTradeResponse, "testTradeResponse");
  }
