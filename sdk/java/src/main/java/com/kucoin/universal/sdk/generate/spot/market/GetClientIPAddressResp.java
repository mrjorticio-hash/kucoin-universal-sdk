...
public class GetClientIPAddressResp
  ...
  @Override
  public void setCommonResponse(RestResponse<GetClientIPAddressResp> response) {
    this.commonResponse = response;
  }

  @JsonCreator
  public static GetClientIPAddressResp fromJson(String data) {
    // original response
    GetClientIPAddressResp obj = new GetClientIPAddressResp();
    obj.data = data;
    return obj;
  }
