...
public class GetStopOrderByOrderIdResp
    implements Response<GetStopOrderByOrderIdResp, RestResponse<GetStopOrderByOrderIdResp>> {
  ...
  /** common response */
  @JsonIgnore private RestResponse<GetStopOrderByOrderIdResp> commonResponse;

  @Override
  public void setCommonResponse(RestResponse<GetStopOrderByOrderIdResp> response) {
