...
public class GetWithdrawDetailResp
    implements Response<GetWithdrawDetailResp, RestResponse<GetWithdrawDetailResp>> {
  /** Withdrawal ID */
  @JsonProperty("id")
  private String id;
  ...
  /** common response */
  @JsonIgnore private RestResponse<GetWithdrawDetailResp> commonResponse;

  @Override
  public void setCommonResponse(RestResponse<GetWithdrawDetailResp> response) {
