...
class MarginPrivateWsAutoGeneratedTest {
  ...
  public static void testCrossMarginPositionResponse() throws Exception {
    ...
    WsMessage<CrossMarginPositionEvent> resp =
        mapper.readValue(data, new TypeReference<WsMessage<CrossMarginPositionEvent>>() {});
  }
  ...
  public static void testIsolatedMarginPositionResponse() throws Exception {
    ...
    WsMessage<IsolatedMarginPositionEvent> resp =
        mapper.readValue(data, new TypeReference<WsMessage<IsolatedMarginPositionEvent>>() {});
  }
