...
public class SwitchMarginModeResp
    implements Response<SwitchMarginModeResp, RestResponse<SwitchMarginModeResp>> {
  /**
  ...
  /** common response */
  @JsonIgnore private RestResponse<SwitchMarginModeResp> commonResponse;

  @Override
  public void setCommonResponse(RestResponse<SwitchMarginModeResp> response) {
