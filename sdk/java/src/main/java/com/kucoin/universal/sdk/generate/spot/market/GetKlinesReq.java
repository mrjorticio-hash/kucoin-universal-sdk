...
public class GetKlinesReq implements Request {
  ...
  /**
   * Type of candlestick patterns: 1min, 3min, 5min, 15min, 30min, 1hour, 2hour,
   * 4hour, 6hour, 8hour, 12hour, 1day, 1week, 1month
   */
  @JsonProperty("type") private TypeEnum type;

  /**
   * Start time (second), default is 0
   */
  @JsonProperty("startAt") @Builder.Default private Long startAt = 0l;

  /**
   * End time (second), default is 0
   */
  @JsonProperty("endAt") @Builder.Default private Long endAt = 0l;
