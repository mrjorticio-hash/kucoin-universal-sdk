...
class MarketApiAutoGeneratedTest {
  ...
  /** getAnnouncements Request Get Announcements /api/v3/announcements */
  public static void testGetAnnouncementsRequest() throws Exception {
    String data =
        "{\\\"currentPage\\\": 1, \\\"pageSize\\\": 50, \\\"annType\\\":"
            + " \\\"latest-announcements\\\", \\\"lang\\\": \\\"en_US\\\", \\\"startTime\\\":"
            + " 1729594043000, \\\"endTime\\\": 1729697729000}";
    GetAnnouncementsReq obj = mapper.readValue(data, GetAnnouncementsReq.class);
  }

  /** getAnnouncements Response Get Announcements /api/v3/announcements */
  public static void testGetAnnouncementsResponse() throws Exception {
    String data =
        "{\\n"
            + "    \\\"code\\\": \\\"200000\\\",\\n"
            + "    \\\"data\\\": {\\n"
            ...
            + "            {\\n"
            + "                \\\"annId\\\": 129045,\\n"
            + "                \\\"annTitle\\\": \\\"KuCoin Isolated Margin Adds the Scroll (SCR)"
            + " Trading Pair\\\",\\n"
            + "                \\\"annType\\\": [\\n"
            + "                    \\\"latest-announcements\\\"\\n"
            + "                ],\\n"
            + "                \\\"annDesc\\\": \\\"To enrich the variety of assets"
            + " available,\\xa0KuCoin\\u2019s Isolated Margin Trading platform has added the Scroll"
            + " (SCR)\\xa0asset and trading pair.\\\",\\n"
            + "                \\\"cTime\\\": 1729594043000,\\n"
            + "                \\\"language\\\": \\\"en_US\\\",\\n"
            + "                \\\"annUrl\\\":"
            + " \\\"https://www.kucoin.com/announcement/kucoin-isolated-margin-adds-scr?lang=en_US\\\"\\n"
            + "            },\\n"
            + "            {\\n"
            + "                \\\"annId\\\": 129001,\\n"
            + "                \\\"annTitle\\\": \\\"DAPP-30D Fixed Promotion, Enjoy an APR of"
            + " 200%!\\u200b\\\",\\n"
            + "                \\\"annType\\\": [\\n"
            + "                    \\\"latest-announcements\\\",\\n"
            + "                    \\\"activities\\\"\\n"
            ...
            + " Promotion at 10:00:00 on October 22, 2024 (UTC). The available product is"
            + " \\u201cDAPP-30D'' with an APR of 200%.\\\",\\n"
            + "                \\\"cTime\\\": 1729588460000,\\n"
            + "                \\\"language\\\": \\\"en_US\\\",\\n"
            + "                \\\"annUrl\\\":"
            + " \\\"https://www.kucoin.com/announcement/dapp-30d-fixed-promotion-enjoy?lang=en_US\\\"\\n"
            + "            },\\n"
            + "            {\\n"
            + "                \\\"annId\\\": 128581,\\n"
            + "                \\\"annTitle\\\": \\\"NAYM (NAYM) Gets Listed on KuCoin! World"
            + " Premiere!\\\",\\n"
            + "                \\\"annType\\\": [\\n"
            + "                    \\\"latest-announcements\\\",\\n"
            + "                    \\\"new-listings\\\"\\n"
            + "                ],\\n"
            + "                \\\"annDesc\\\": \\\"Trading:\\xa011:00 on October 22, 2024"
            + " (UTC)\\\",\\n"
            + "                \\\"cTime\\\": 1729497729000,\\n"
            + "                \\\"language\\\": \\\"en_US\\\",\\n"
            + "                \\\"annUrl\\\":"
            + " \\\"https://www.kucoin.com/announcement/en-naym-naym-gets-listed-on-kucoin-world-premiere?lang=en_US\\\"\\n"
            + "            }\\n"
            + "        ]\\n"
            + "    }\\n"
            + "}";
    RestResponse<GetAnnouncementsResp> resp =
        mapper.readValue(data, new TypeReference<RestResponse<GetAnnouncementsResp>>() {});
  }

  /** getCurrency Request Get Currency /api/v3/currencies/{currency} */
  public static void testGetCurrencyRequest() throws Exception {
    String data = "{\\\"chain\\\": \\\"eth\\\", \\\"currency\\\": \\\"BTC\\\"}";
    GetCurrencyReq obj = mapper.readValue(data, GetCurrencyReq.class);
  }

  /** getCurrency Response Get Currency /api/v3/currencies/{currency} */
  public static void testGetCurrencyResponse() throws Exception {
    String data =
        "{\\\"code\\\":\\\"200000\\\",\\\"data\\\":{\\\"currency\\\":\\\"BTC\\\",\\\"name\\\":\\\"BTC\\\",\\\"fullName\\\":\\\"Bitcoin\\\",\\\"precision\\\":8,\\\"confirms\\\":null,\\\"contractAddress\\\":null,\\\"isMarginEnabled\\\":true,\\\"isDebitEnabled\\\":true,\\\"chains\\\":[{\\\"chainName\\\":\\\"BTC\\\",\\\"withdrawalMinSize\\\":\\\"0.001\\\",\\\"depositMinSize\\\":\\\"0.0002\\\",\\\"withdrawFeeRate\\\":\\\"0\\\",\\\"withdrawalMinFee\\\":\\\"0.0005\\\",\\\"isWithdrawEnabled\\\":true,\\\"isDepositEnabled\\\":true,\\\"confirms\\\":3,\\\"preConfirms\\\":1,\\\"contractAddress\\\":\\\"\\\",\\\"withdrawPrecision\\\":8,\\\"maxWithdraw\\\":null,\\\"maxDeposit\\\":null,\\\"needTag\\\":false,\\\"chainId\\\":\\\"btc\\\"},{\\\"chainName\\\":\\\"Lightning"
            + " Network\\\",\\\"withdrawalMinSize\\\":\\\"0.00001\\\",\\\"depositMinSize\\\":\\\"0.00001\\\",\\\"withdrawFeeRate\\\":\\\"0\\\",\\\"withdrawalMinFee\\\":\\\"0.000015\\\",\\\"isWithdrawEnabled\\\":true,\\\"isDepositEnabled\\\":true,\\\"confirms\\\":1,\\\"preConfirms\\\":1,\\\"contractAddress\\\":\\\"\\\",\\\"withdrawPrecision\\\":8,\\\"maxWithdraw\\\":null,\\\"maxDeposit\\\":\\\"0.03\\\",\\\"needTag\\\":false,\\\"chainId\\\":\\\"btcln\\\"},{\\\"chainName\\\":\\\"KCC\\\",\\\"withdrawalMinSize\\\":\\\"0.0008\\\",\\\"depositMinSize\\\":null,\\\"withdrawFeeRate\\\":\\\"0\\\",\\\"withdrawalMinFee\\\":\\\"0.00002\\\",\\\"isWithdrawEnabled\\\":true,\\\"isDepositEnabled\\\":true,\\\"confirms\\\":20,\\\"preConfirms\\\":20,\\\"contractAddress\\\":\\\"0xfa93c12cd345c658bc4644d1d4e1b9615952258c\\\",\\\"withdrawPrecision\\\":8,\\\"maxWithdraw\\\":null,\\\"maxDeposit\\\":null,\\\"needTag\\\":false,\\\"chainId\\\":\\\"kcc\\\"},{\\\"chainName\\\":\\\"BTC-Segwit\\\",\\\"withdrawalMinSize\\\":\\\"0.0008\\\",\\\"depositMinSize\\\":\\\"0.0002\\\",\\\"withdrawFeeRate\\\":\\\"0\\\",\\\"withdrawalMinFee\\\":\\\"0.0005\\\",\\\"isWithdrawEnabled\\\":false,\\\"isDepositEnabled\\\":true,\\\"confirms\\\":2,\\\"preConfirms\\\":2,\\\"contractAddress\\\":\\\"\\\",\\\"withdrawPrecision\\\":8,\\\"maxWithdraw\\\":null,\\\"maxDeposit\\\":null,\\\"needTag\\\":false,\\\"chainId\\\":\\\"bech32\\\"}]}}";
    RestResponse<GetCurrencyResp> resp =
        mapper.readValue(data, new TypeReference<RestResponse<GetCurrencyResp>>() {});
  }

  /** getAllCurrencies Request Get All Currencies /api/v3/currencies */
  public static void testGetAllCurrenciesRequest() throws Exception {
    // $this->assertTrue(true);
  }

  /** getAllCurrencies Response Get All Currencies /api/v3/currencies */
  public static void testGetAllCurrenciesResponse() throws Exception {
    String data =
        "{\\n"
            + "    \\\"code\\\": \\\"200000\\\",\\n"
            + "    \\\"data\\\": [\\n"
            ...
            + "    ]\\n"
            + "}";
    RestResponse<GetAllCurrenciesResp> resp =
        mapper.readValue(data, new TypeReference<RestResponse<GetAllCurrenciesResp>>() {});
  }

  /** getSymbol Request Get Symbol /api/v2/symbols/{symbol} */
  ...
  /** getSymbol Response Get Symbol /api/v2/symbols/{symbol} */
  ...
  /** getAllSymbols Request Get All Symbols /api/v2/symbols */
  public static void testGetAllSymbolsRequest() throws Exception {
    String data = "{\\\"market\\\": \\\"ALTS\\\"}";
    GetAllSymbolsReq obj = mapper.readValue(data, GetAllSymbolsReq.class);
  }

  /** getAllSymbols Response Get All Symbols /api/v2/symbols */
  ...
  /** getTicker Request Get Ticker /api/v1/market/orderbook/level1 */
  public static void testGetTickerRequest() throws Exception {
    String data = "{\\\"symbol\\\": \\\"BTC-USDT\\\"}";
    GetTickerReq obj = mapper.readValue(data, GetTickerReq.class);
  }

  /** getTicker Response Get Ticker /api/v1/market/orderbook/level1 */
  ...
  /** getAllTickers Request Get All Tickers /api/v1/market/allTickers */
  public static void testGetAllTickersRequest() throws Exception {
    // $this->assertTrue(true);
  }

  /** getAllTickers Response Get All Tickers /api/v1/market/allTickers */
  ...
  /** getTradeHistory Request Get Trade History /api/v1/market/histories */
  ...
  /** getTradeHistory Response Get Trade History /api/v1/market/histories */
  ...
  /** getKlines Request Get Klines /api/v1/market/candles */
  public static void testGetKlinesRequest() throws Exception {
    String data =
        "{\\\"symbol\\\": \\\"BTC-USDT\\\", \\\"type\\\": \\\"1min\\\", \\\"startAt\\\":"
            + " 1566703297, \\\"endAt\\\": 1566789757}";
    GetKlinesReq obj = mapper.readValue(data, GetKlinesReq.class);
  }

  /** getKlines Response Get Klines /api/v1/market/candles */
  ...
  /** getPartOrderBook Request Get Part OrderBook /api/v1/market/orderbook/level2_{size} */
  public static void testGetPartOrderBookRequest() throws Exception {
    String data = "{\\\"symbol\\\": \\\"BTC-USDT\\\", \\\"size\\\": \\\"20\\\"}";
    GetPartOrderBookReq obj = mapper.readValue(data, GetPartOrderBookReq.class);
  }

  /** getPartOrderBook Response Get Part OrderBook /api/v1/market/orderbook/level2_{size} */
  ...
  /** getFullOrderBook Request Get Full OrderBook /api/v3/market/orderbook/level2 */
  ...
  /** getFullOrderBook Response Get Full OrderBook /api/v3/market/orderbook/level2 */
  ...
  /**
   * getCallAuctionPartOrderBook Request Get Call Auction Part OrderBook
   * /api/v1/market/orderbook/callauction/level2_{size}
   */
  public static void testGetCallAuctionPartOrderBookRequest() throws Exception {
    String data = "{\\\"symbol\\\": \\\"BTC-USDT\\\", \\\"size\\\": \\\"20\\\"}";
    GetCallAuctionPartOrderBookReq obj =
        mapper.readValue(data, GetCallAuctionPartOrderBookReq.class);
  }

  /**
   * getCallAuctionPartOrderBook Response Get Call Auction Part OrderBook
   * /api/v1/market/orderbook/callauction/level2_{size}
   */
  public static void testGetCallAuctionPartOrderBookResponse() throws Exception {
    String data =
        "{\\n"
            + "    \\\"code\\\": \\\"200000\\\",\\n"
            + "    \\\"data\\\": {\\n"
            ...
            + "    }\\n"
            + "}";
    RestResponse<GetCallAuctionPartOrderBookResp> resp =
        mapper.readValue(
            data, new TypeReference<RestResponse<GetCallAuctionPartOrderBookResp>>() {});
  }

  /** getCallAuctionInfo Request Get Call Auction Info /api/v1/market/callauctionData */
  public static void testGetCallAuctionInfoRequest() throws Exception {
    String data = "{\\\"symbol\\\": \\\"BTC-USDT\\\"}";
    GetCallAuctionInfoReq obj = mapper.readValue(data, GetCallAuctionInfoReq.class);
  }

  /** getCallAuctionInfo Response Get Call Auction Info /api/v1/market/callauctionData */
  public static void testGetCallAuctionInfoResponse() throws Exception {
    String data =
        "{\\n"
            + "    \\\"code\\\": \\\"200000\\\",\\n"
            + "    \\\"data\\\": {\\n"
            ...
            + "    }\\n"
            + "}";
    RestResponse<GetCallAuctionInfoResp> resp =
        mapper.readValue(data, new TypeReference<RestResponse<GetCallAuctionInfoResp>>() {});
  }

  /** getFiatPrice Request Get Fiat Price /api/v1/prices */
  public static void testGetFiatPriceRequest() throws Exception {
    String data =
        "{\\\"base\\\": \\\"USD\\\", \\\"currencies\\\": \\\"example_string_default_value\\\"}";
    GetFiatPriceReq obj = mapper.readValue(data, GetFiatPriceReq.class);
  }

  /** getFiatPrice Response Get Fiat Price /api/v1/prices */
  public static void testGetFiatPriceResponse() throws Exception {
    String data =
    ...
    RestResponse<GetFiatPriceResp> resp =
        mapper.readValue(data, new TypeReference<RestResponse<GetFiatPriceResp>>() {});
  }

  /** get24hrStats Request Get 24hr Stats /api/v1/market/stats */
  public static void testGet24hrStatsRequest() throws Exception {
    String data = "{\\\"symbol\\\": \\\"BTC-USDT\\\"}";
    Get24hrStatsReq obj = mapper.readValue(data, Get24hrStatsReq.class);
  }

  /** get24hrStats Response Get 24hr Stats /api/v1/market/stats */
  ...
  /** getMarketList Request Get Market List /api/v1/markets */
  public static void testGetMarketListRequest() throws Exception {
    // $this->assertTrue(true);
  }

  /** getMarketList Response Get Market List /api/v1/markets */
  public static void testGetMarketListResponse() throws Exception {
    String data =
        "{\\\"code\\\":\\\"200000\\\",\\\"data\\\":[\\\"USDS\\\",\\\"TON\\\",\\\"AI\\\",\\\"DePIN\\\",\\\"PoW\\\",\\\"BRC-20\\\",\\\"ETF\\\",\\\"KCS\\\",\\\"Meme\\\",\\\"Solana\\\",\\\"FIAT\\\",\\\"VR&AR\\\",\\\"DeFi\\\",\\\"Polkadot\\\",\\\"BTC\\\",\\\"ALTS\\\",\\\"Layer"
            + " 1\\\"]}";
    RestResponse<GetMarketListResp> resp =
        mapper.readValue(data, new TypeReference<RestResponse<GetMarketListResp>>() {});
  }

  /** getClientIPAddress Request Get Client IP Address /api/v1/my-ip */
  public static void testGetClientIPAddressRequest() throws Exception {
    // $this->assertTrue(true);
  }

  /** getClientIPAddress Response Get Client IP Address /api/v1/my-ip */
  public static void testGetClientIPAddressResponse() throws Exception {
    String data = "{\\\"code\\\":\\\"200000\\\",\\\"data\\\":\\\"20.***.***.128\\\"}";
    RestResponse<GetClientIPAddressResp> resp =
        mapper.readValue(data, new TypeReference<RestResponse<GetClientIPAddressResp>>() {});
  }
  ...
  public static void testGetServerTimeResponse() throws Exception {
    String data = "{\\\"code\\\":\\\"200000\\\",\\\"data\\\":1729100692873}";
  ...
  /** getPublicToken Request Get Public Token - Spot/Margin /api/v1/bullet-public */
  public static void testGetPublicTokenRequest() throws Exception {
    // $this->assertTrue(true);
  }

  /** getPublicToken Response Get Public Token - Spot/Margin /api/v1/bullet-public */
  public static void testGetPublicTokenResponse() throws Exception {
    String data =
        "{\\n"
            ...
            + "    \\\"data\\\": {\\n"
            + "        \\\"token\\\":"
            + " \\\"2neAiuYvAU61ZDXANAGAsiL4-iAExhsBXZxftpOeh_55i3Ysy2q2LEsEWU64mdzUOPusi34M_wGoSf7iNyEWJ93g2WHl-j4M7tCZ_S21PuIByWXUJFDywtiYB9J6i9GjsxUuhPw3Blq6rhZlGykT3Vp1phUafnulOOpts-MEmEF-3bpfetLOAq79RbGaLlE4JBvJHl5Vs9Y=.ymP9jIr6v-vucrZr8761yA==\\\",\\n"
            + "        \\\"instanceServers\\\": [\\n"
            + "            {\\n"
  ...
  /** getPrivateToken Request Get Private Token - Spot/Margin /api/v1/bullet-private */
  public static void testGetPrivateTokenRequest() throws Exception {
    // $this->assertTrue(true);
  }

  /** getPrivateToken Response Get Private Token - Spot/Margin /api/v1/bullet-private */
  public static void testGetPrivateTokenResponse() throws Exception {
    String data =
        "{\\n"
            ...
            + "    \\\"data\\\": {\\n"
            + "        \\\"token\\\":"
            + " \\\"2neAiuYvAU737TOajb2U3uT8AEZqSWYe0fBD4LoHuXJDSC7gIzJiH4kNTWhCPISWo6nDpAe7aUaaHJ4fG8oRjFgMfUI2sM4IySWHrBceFocY8pKy2REU1HwZIngtMdMrjqPnP-biofFWbNaP1cl0X1pZc2SQ-33hDH1LgNP-yg80ZJv_Ctaj8sAFhTOZ8m1L.jut4vBQxXAseWKxODdGVGg==\\\",\\n"
            + "        \\\"instanceServers\\\": [\\n"
            + "            {\\n"
            + "                \\\"endpoint\\\": \\\"wss://ws-api-spot.kucoin.com/\\\",\\n"
            + "                \\\"encrypt\\\": true,\\n"
  ...
  public static void runAllTests() {
    run(MarketApiAutoGeneratedTest::testGetAnnouncementsRequest, "testGetAnnouncementsRequest");
    run(MarketApiAutoGeneratedTest::testGetAnnouncementsResponse, "testGetAnnouncementsResponse");
    run(MarketApiAutoGeneratedTest::testGetCurrencyRequest, "testGetCurrencyRequest");
    run(MarketApiAutoGeneratedTest::testGetCurrencyResponse, "testGetCurrencyResponse");
    run(MarketApiAutoGeneratedTest::testGetAllCurrenciesRequest, "testGetAllCurrenciesRequest");
    run(MarketApiAutoGeneratedTest::testGetAllCurrenciesResponse, "testGetAllCurrenciesResponse");
    ...
    run(
        MarketApiAutoGeneratedTest::testGetCallAuctionPartOrderBookRequest,
        "testGetCallAuctionPartOrderBookRequest");
    run(
        MarketApiAutoGeneratedTest::testGetCallAuctionPartOrderBookResponse,
        "testGetCallAuctionPartOrderBookResponse");
    run(MarketApiAutoGeneratedTest::testGetCallAuctionInfoRequest, "testGetCallAuctionInfoRequest");
    run(
        MarketApiAutoGeneratedTest::testGetCallAuctionInfoResponse,
        "testGetCallAuctionInfoResponse");
    run(MarketApiAutoGeneratedTest::testGetFiatPriceRequest, "testGetFiatPriceRequest");
    run(MarketApiAutoGeneratedTest::testGetFiatPriceResponse, "testGetFiatPriceResponse");
    ...
    run(MarketApiAutoGeneratedTest::testGetMarketListRequest, "testGetMarketListRequest");
    run(MarketApiAutoGeneratedTest::testGetMarketListResponse, "testGetMarketListResponse");
    run(MarketApiAutoGeneratedTest::testGetClientIPAddressRequest, "testGetClientIPAddressRequest");
    run(
        MarketApiAutoGeneratedTest::testGetClientIPAddressResponse,
        "testGetClientIPAddressResponse");
