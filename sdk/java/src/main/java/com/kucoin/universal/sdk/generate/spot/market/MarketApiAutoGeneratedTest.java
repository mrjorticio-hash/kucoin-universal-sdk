...
class MarketApiAutoGeneratedTest {
  ...
  public static void testGetAnnouncementsRequest() throws Exception {
    String data =
        "{\"currentPage\": 1, \"pageSize\": 50, \"annType\": \"latest-announcements\", \"lang\":"
            + " \"en_US\", \"startTime\": 1729594043000, \"endTime\": 1729697729000}";
  ...
  public static void testGetAnnouncementsResponse() throws Exception {
    String data =
        "{\n"
            ...
            + "            {\n"
            + "                \"annId\": 129045,\n"
            + "                \"annTitle\": \"KuCoin Isolated Margin Adds the Scroll (SCR) Trading"
            + " Pair\",\n"
            + "                \"annType\": [\n"
  ...
  public static void testGetKlinesRequest() throws Exception {
    String data =
        "{\"symbol\": \"BTC-USDT\", \"type\": \"1min\", \"startAt\": 1566703297, \"endAt\":"
            + " 1566789757}";
  ...
  public static void testGetFiatPriceRequest() throws Exception {
    String data = "{\"base\": \"USD\", \"currencies\": \"example_string_default_value\"}";
  ...
  public static void testGetServiceStatusResponse() throws Exception {
    String data = "{\"code\":\"200000\",\"data\":{\"status\":\"open\",\"msg\":\"\"}}";
