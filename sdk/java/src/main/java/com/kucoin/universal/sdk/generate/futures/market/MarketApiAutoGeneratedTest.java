...
class MarketApiAutoGeneratedTest {
  ...
  public static void testGetKlinesRequest() throws Exception {
    String data =
        "{\\\"symbol\\\": \\\"XBTUSDTM\\\", \\\"granularity\\\": 1, \\\"from\\\": 1728552342000,"
            + " \\\"to\\\": 1729243542000}";
  ...
  public static void testGetSpotIndexPriceRequest() throws Exception {
    String data =
        "{\\\"symbol\\\": \\\".KXBTUSDT\\\", \\\"startAt\\\": 123456, \\\"endAt\\\": 123456,"
            + " \\\"reverse\\\": true, \\\"offset\\\": 123456, \\\"forward\\\": true,"
            + " \\\"maxCount\\\": 10}";
  ...
  public static void testGetInterestRateIndexRequest() throws Exception {
    String data =
        "{\\\"symbol\\\": \\\".XBTINT8H\\\", \\\"startAt\\\": 1728663338000, \\\"endAt\\\":"
            + " 1728692138000, \\\"reverse\\\": true, \\\"offset\\\": 254062248624417,"
            + " \\\"forward\\\": true, \\\"maxCount\\\": 10}";
  ...
  public static void testGetPremiumIndexRequest() throws Exception {
    String data =
        "{\\\"symbol\\\": \\\".XBTUSDTMPI\\\", \\\"startAt\\\": 1728663338000, \\\"endAt\\\":"
            + " 1728692138000, \\\"reverse\\\": true, \\\"offset\\\": 254062248624417,"
            + " \\\"forward\\\": true, \\\"maxCount\\\": 10}";
