...
class WithdrawalApiAutoGeneratedTest {
  ...
  public static void testWithdrawalV3Request() throws Exception {
    String data =
        "{\"currency\": \"USDT\", \"toAddress\": \"TKFRQXSDcY****GmLrjJggwX8\", \"amount\": \"3\","
            + " \"withdrawType\": \"ADDRESS\", \"chain\": \"trx\", \"isInner\": true, \"remark\":"
            + " \"this is Remark\"}";
  ...
  public static void testWithdrawalV3Response() throws Exception {
    String data = "{\"code\":\"200000\",\"data\":{\"withdrawalId\":\"670deec84d64da0007d7c946\"}}";
  ...
  public static void testWithdrawalV1Request() throws Exception {
    String data =
        "{\"currency\": \"USDT\", \"address\": \"TKFRQXSDc****16GmLrjJggwX8\", \"amount\": 3,"
            + " \"chain\": \"trx\", \"isInner\": true}";
