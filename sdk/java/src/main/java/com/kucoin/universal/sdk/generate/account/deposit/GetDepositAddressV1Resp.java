...
public class GetDepositAddressV1Resp
    implements Response<GetDepositAddressV1Resp, RestResponse<GetDepositAddressV1Resp>> {
  /** Deposit address */
  ...
  /** common response */
  @JsonIgnore private RestResponse<GetDepositAddressV1Resp> commonResponse;

  @Override
  public void setCommonResponse(RestResponse<GetDepositAddressV1Resp> response) {
