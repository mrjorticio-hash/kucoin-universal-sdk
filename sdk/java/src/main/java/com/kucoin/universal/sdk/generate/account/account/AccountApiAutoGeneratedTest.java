...
class AccountApiAutoGeneratedTest {
  ...
  public static void testGetIsolatedMarginAccountRequest() throws Exception {
    String data =
        "{\\\"symbol\\\": \\\"BTC-USDT\\\", \\\"quoteCurrency\\\": \\\"USDT\\\", \\\"queryType\\\":"
            + " \\\"ISOLATED\\\"}";
  ...
  public static void testGetSpotLedgerRequest() throws Exception {
    String data =
        "{\\\"currency\\\": \\\"BTC\\\", \\\"direction\\\": \\\"in\\\", \\\"bizType\\\":"
            + " \\\"TRANSFER\\\", \\\"startAt\\\": 1728663338000, \\\"endAt\\\": 1728692138000,"
  ...
  public static void testGetSpotHFLedgerRequest() throws Exception {
    String data =
        "{\\\"currency\\\": \\\"BTC\\\", \\\"direction\\\": \\\"in\\\", \\\"bizType\\\":"
            + " \\\"TRANSFER\\\", \\\"lastId\\\": 254062248624417, \\\"limit\\\": 100,"
  ...
  public static void testGetFuturesLedgerRequest() throws Exception {
    String data =
        "{\\\"currency\\\": \\\"XBT\\\", \\\"type\\\": \\\"Transferin\\\", \\\"offset\\\":"
            + " 254062248624417, \\\"forward\\\": true, \\\"maxCount\\\": 50, \\\"startAt\\\":"
  ...
  public static void testGetFuturesLedgerResponse() throws Exception {
    String data =
        "{\\n"
            ...
            + "                \\\"status\\\": \\\"Completed\\\",\\n"
            + "                \\\"remark\\\": \\\"Transferred from High-Frequency Trading"
            + " Account\\\",\\n"
            + "                \\\"offset\\\": 51360793,\\n"
            + "                \\\"currency\\\": \\\"USDT\\\"\\n"
            + "            },\\n"
