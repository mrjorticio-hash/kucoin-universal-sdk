...
class OrderApiAutoGeneratedTest {
  ...
  public static void testAddOrderSyncRequest() throws Exception {
    String data =
        "{\\\"type\\\": \\\"limit\\\", \\\"symbol\\\": \\\"BTC-USDT\\\", \\\"side\\\": \\\"buy\\\","
            + " \\\"price\\\": \\\"50000\\\", \\\"size\\\": \\\"0.00001\\\", \\\"clientOid\\\":"
            + " \\\"5c52e11203aa677f33e493f\\\", \\\"remark\\\": \\\"order remarks\\\"}";
  ...
  public static void testBatchAddOrdersRequest() throws Exception {
    String data =
        "{\\\"orderList\\\": [{\\\"clientOid\\\": \\\"client order id 12\\\", \\\"symbol\\\":"
            + " \\\"BTC-USDT\\\", \\\"type\\\": \\\"limit\\\", \\\"side\\\": \\\"buy\\\","
            + " \\\"price\\\": \\\"30000\\\", \\\"size\\\": \\\"0.00001\\\"}, {\\\"clientOid\\\":"
            + " \\\"client order id 13\\\", \\\"symbol\\\": \\\"ETH-USDT\\\", \\\"type\\\":"
            + " \\\"limit\\\", \\\"side\\\": \\\"sell\\\", \\\"price\\\": \\\"2000\\\","
            + " \\\"size\\\": \\\"0.00001\\\"}]}";
  ...
  public static void testBatchAddOrdersSyncRequest() throws Exception {
    String data =
        "{\\\"orderList\\\": [{\\\"clientOid\\\": \\\"client order id 13\\\", \\\"symbol\\\":"
            + " \\\"BTC-USDT\\\", \\\"type\\\": \\\"limit\\\", \\\"side\\\": \\\"buy\\\","
            + " \\\"price\\\": \\\"30000\\\", \\\"size\\\": \\\"0.00001\\\"}, {\\\"clientOid\\\":"
            + " \\\"client order id 14\\\", \\\"symbol\\\": \\\"ETH-USDT\\\", \\\"type\\\":"
            + " \\\"limit\\\", \\\"side\\\": \\\"sell\\\", \\\"price\\\": \\\"2000\\\","
            + " \\\"size\\\": \\\"0.00001\\\"}]}";
  ...
  public static void testCancelPartialOrderRequest() throws Exception {
    String data =
        "{\\\"orderId\\\": \\\"6711f73c1ef16c000717bb31\\\", \\\"symbol\\\": \\\"BTC-USDT\\\","
            + " \\\"cancelSize\\\": \\\"0.00001\\\"}";
  ...
  public static void testModifyOrderRequest() throws Exception {
    String data =
        "{\\\"symbol\\\": \\\"BTC-USDT\\\", \\\"orderId\\\": \\\"670fd33bf9406e0007ab3945\\\","
            + " \\\"newPrice\\\": \\\"30000\\\", \\\"newSize\\\": \\\"0.0001\\\"}";
  ...
  public static void testGetClosedOrdersRequest() throws Exception {
    String data =
        "{\\\"symbol\\\": \\\"BTC-USDT\\\", \\\"side\\\": \\\"buy\\\", \\\"type\\\": \\\"limit\\\","
            + " \\\"lastId\\\": 254062248624417, \\\"limit\\\": 20, \\\"startAt\\\": 1728663338000,"
            + " \\\"endAt\\\": 1728692138000}";
  ...
  public static void testGetTradeHistoryRequest() throws Exception {
    String data =
        "{\\\"symbol\\\": \\\"BTC-USDT\\\", \\\"orderId\\\": \\\"example_string_default_value\\\","
            + " \\\"side\\\": \\\"buy\\\", \\\"type\\\": \\\"limit\\\", \\\"lastId\\\":"
  ...
  public static void testAddStopOrderRequest() throws Exception {
    String data =
        "{\\\"type\\\": \\\"limit\\\", \\\"symbol\\\": \\\"BTC-USDT\\\", \\\"side\\\": \\\"buy\\\","
            + " \\\"price\\\": \\\"50000\\\", \\\"stopPrice\\\": \\\"50000\\\", \\\"size\\\":"
            + " \\\"0.00001\\\", \\\"clientOid\\\": \\\"5c52e11203aa677f33e493fb\\\","
            + " \\\"remark\\\": \\\"order remarks\\\"}";
  ...
  public static void testCancelStopOrderByClientOidRequest() throws Exception {
    String data =
        "{\\\"symbol\\\": \\\"BTC-USDT\\\", \\\"clientOid\\\":"
            + " \\\"689ff597f4414061aa819cc414836abd\\\"}";
  ...
  public static void testBatchCancelStopOrderRequest() throws Exception {
    String data =
        "{\\\"symbol\\\": \\\"example_string_default_value\\\", \\\"tradeType\\\":"
            + " \\\"example_string_default_value\\\", \\\"orderIds\\\":"
  ...
  public static void testGetStopOrdersListRequest() throws Exception {
    String data =
        "{\\\"symbol\\\": \\\"example_string_default_value\\\", \\\"side\\\":"
            + " \\\"example_string_default_value\\\", \\\"type\\\": \\\"limit\\\","
            + " \\\"tradeType\\\": \\\"example_string_default_value\\\", \\\"startAt\\\": 123456,"
            + " \\\"endAt\\\": 123456, \\\"currentPage\\\": 1, \\\"orderIds\\\":"
  ...
  public static void testAddOcoOrderRequest() throws Exception {
    String data =
        "{\\\"symbol\\\": \\\"BTC-USDT\\\", \\\"side\\\": \\\"buy\\\", \\\"price\\\":"
            + " \\\"94000\\\", \\\"size\\\": \\\"0.1\\\", \\\"clientOid\\\":"
            + " \\\"5c52e11203aa67f1e493fb\\\", \\\"stopPrice\\\": \\\"98000\\\","
            + " \\\"limitPrice\\\": \\\"96000\\\", \\\"remark\\\": \\\"this is remark\\\","
            + " \\\"tradeType\\\": \\\"TRADE\\\"}";
  ...
  public static void testGetOcoOrderListRequest() throws Exception {
    String data =
        "{\\\"symbol\\\": \\\"BTC-USDT\\\", \\\"startAt\\\": 123456, \\\"endAt\\\": 123456,"
            + " \\\"orderIds\\\": \\\"example_string_default_value\\\", \\\"pageSize\\\": 50,"
            + " \\\"currentPage\\\": 1}";
  ...
  public static void testBatchAddOrdersOldRequest() throws Exception {
    String data =
        "{\\\"symbol\\\": \\\"BTC-USDT\\\", \\\"orderList\\\": [{\\\"clientOid\\\":"
            + " \\\"3d07008668054da6b3cb12e432c2b13a\\\", \\\"side\\\": \\\"buy\\\", \\\"type\\\":"
            + " \\\"limit\\\", \\\"price\\\": \\\"50000\\\", \\\"size\\\": \\\"0.0001\\\"},"
            + " {\\\"clientOid\\\": \\\"37245dbe6e134b5c97732bfb36cd4a9d\\\", \\\"side\\\":"
            + " \\\"buy\\\", \\\"type\\\": \\\"limit\\\", \\\"price\\\": \\\"49999\\\","
            + " \\\"size\\\": \\\"0.0001\\\"}]}";
  ...
  public static void testGetOrdersListOldRequest() throws Exception {
    String data =
        "{\\\"symbol\\\": \\\"BTC-USDT\\\", \\\"status\\\": \\\"active\\\", \\\"side\\\":"
            + " \\\"buy\\\", \\\"type\\\": \\\"limit\\\", \\\"tradeType\\\": \\\"TRADE\\\","
            + " \\\"startAt\\\": 123456, \\\"endAt\\\": 123456, \\\"currentPage\\\": 1,"
            + " \\\"pageSize\\\": 50}";
  ...
  public static void testGetTradeHistoryOldRequest() throws Exception {
    String data =
        "{\\\"symbol\\\": \\\"BTC-USDT\\\", \\\"orderId\\\": \\\"example_string_default_value\\\","
            + " \\\"side\\\": \\\"buy\\\", \\\"type\\\": \\\"limit\\\", \\\"tradeType\\\":"
            + " \\\"TRADE\\\", \\\"startAt\\\": 1728663338000, \\\"endAt\\\": 1728692138000,"
