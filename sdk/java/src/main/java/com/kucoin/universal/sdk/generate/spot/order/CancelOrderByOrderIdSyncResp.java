...
public class CancelOrderByOrderIdSyncResp
    implements Response<CancelOrderByOrderIdSyncResp, RestResponse<CancelOrderByOrderIdSyncResp>> {
  /** order id */
  ...
  /** common response */
  @JsonIgnore private RestResponse<CancelOrderByOrderIdSyncResp> commonResponse;

  @Override
  public void setCommonResponse(RestResponse<CancelOrderByOrderIdSyncResp> response) {
