...
class NDBrokerApiAutoGeneratedTest {
  ...
  public static void testSubmitKYCRequest() throws Exception {
    String data =
        "{\\\"clientUid\\\": \\\"226383154\\\", \\\"firstName\\\": \\\"Kaylah\\\","
            + " \\\"lastName\\\": \\\"Padberg\\\", \\\"issueCountry\\\": \\\"JP\\\","
            + " \\\"birthDate\\\": \\\"2000-01-01\\\", \\\"expireDate\\\": \\\"2030-01-01\\\","
            + " \\\"identityType\\\": \\\"passport\\\", \\\"identityNumber\\\": \\\"55\\\","
            + " \\\"facePhoto\\\":"
  ...
  public static void testGetBrokerInfoRequest() throws Exception {
    String data =
        "{\\\"begin\\\": \\\"20240510\\\", \\\"end\\\": \\\"20241010\\\", \\\"tradeType\\\":"
            + " \\\"1\\\"}";
  ...
  public static void testAddSubAccountApiRequest() throws Exception {
    String data =
        "{\\\"uid\\\": \\\"226383154\\\", \\\"passphrase\\\": \\\"11223344\\\","
            + " \\\"ipWhitelist\\\": [\\\"127.0.0.1\\\", \\\"123.123.123.123\\\"],"
            + " \\\"permissions\\\": [\\\"general\\\", \\\"spot\\\"], \\\"label\\\": \\\"This is"
            + " remarks\\\"}";
  ...
  public static void testTransferRequest() throws Exception {
    String data =
        "{\\\"currency\\\": \\\"USDT\\\", \\\"amount\\\": \\\"1\\\", \\\"clientOid\\\":"
            + " \\\"e6c24d23-6bc2-401b-bf9e-55e2daddfbc1\\\", \\\"direction\\\": \\\"OUT\\\","
            + " \\\"accountType\\\": \\\"MAIN\\\", \\\"specialUid\\\": \\\"226383154\\\","
  ...
  public static void testGetDepositListRequest() throws Exception {
    String data =
        "{\\\"currency\\\": \\\"USDT\\\", \\\"status\\\": \\\"SUCCESS\\\", \\\"hash\\\":"
            + " \\\"example_string_default_value\\\", \\\"startTimestamp\\\": 123456,"
            + " \\\"endTimestamp\\\": 123456, \\\"limit\\\": 100}";
