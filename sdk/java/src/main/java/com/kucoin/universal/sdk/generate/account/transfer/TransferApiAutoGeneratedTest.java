...
class TransferApiAutoGeneratedTest {
  ...
  public static void testFlexTransferRequest() throws Exception {
    String data =
        "{\\\"clientOid\\\": \\\"64ccc0f164781800010d8c09\\\", \\\"type\\\": \\\"PARENT_TO_SUB\\\","
            + " \\\"currency\\\": \\\"USDT\\\", \\\"amount\\\": \\\"0.01\\\","
            + " \\\"fromAccountType\\\": \\\"TRADE\\\", \\\"toUserId\\\":"
  ...
  public static void testSubAccountTransferRequest() throws Exception {
    String data =
        "{\\\"clientOid\\\": \\\"64ccc0f164781800010d8c09\\\", \\\"currency\\\": \\\"USDT\\\","
            + " \\\"amount\\\": \\\"0.01\\\", \\\"direction\\\": \\\"OUT\\\", \\\"accountType\\\":"
            + " \\\"MAIN\\\", \\\"subAccountType\\\": \\\"MAIN\\\", \\\"subUserId\\\":"
            + " \\\"63743f07e0c5230001761d08\\\"}";
  ...
  public static void testGetFuturesAccountTransferOutLedgerRequest() throws Exception {
    String data =
        "{\\\"currency\\\": \\\"XBT\\\", \\\"type\\\": \\\"MAIN\\\", \\\"tag\\\": [\\\"mock_a\\\","
            + " \\\"mock_b\\\"], \\\"startAt\\\": 1728663338000, \\\"endAt\\\": 1728692138000,"
  ...
  public static void testFuturesAccountTransferOutRequest() throws Exception {
    String data =
        "{\\\"currency\\\": \\\"USDT\\\", \\\"amount\\\": 0.01, \\\"recAccountType\\\":"
            + " \\\"MAIN\\\"}";
  ...
  public static void testFuturesAccountTransferInRequest() throws Exception {
    String data =
        "{\\\"currency\\\": \\\"USDT\\\", \\\"amount\\\": 0.01, \\\"payAccountType\\\":"
            + " \\\"MAIN\\\"}";
