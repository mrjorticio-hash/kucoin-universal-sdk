...
class MarginPublicWsAutoGeneratedTest {
  ...
  public static void testIndexPriceResponse() throws Exception {
    ...
    WsMessage<IndexPriceEvent> resp =
        mapper.readValue(data, new TypeReference<WsMessage<IndexPriceEvent>>() {});
  }
  ...
  public static void testMarkPriceResponse() throws Exception {
    ...
    WsMessage<MarkPriceEvent> resp =
        mapper.readValue(data, new TypeReference<WsMessage<MarkPriceEvent>>() {});
  }
