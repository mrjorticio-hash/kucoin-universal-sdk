...
public class AddOrderTestV1Req implements Request {
  /**
  ...
  /**
   * [Self Trade Prevention](https://www.kucoin.com/docs-new/api-5176570) is divided into four
  ...
  /**
   * The type of trading, including cross (cross mode) and isolated (isolated mode). It is set at
   * cross by default.
   */
  @JsonProperty("marginModel")
  @Builder.Default
  private MarginModelEnum marginModel = MarginModelEnum.CROSS;
  ...
  public enum MarginModelEnum {
    ...
    @JsonCreator
    public static MarginModelEnum fromValue(String value) {
      for (MarginModelEnum b : MarginModelEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
