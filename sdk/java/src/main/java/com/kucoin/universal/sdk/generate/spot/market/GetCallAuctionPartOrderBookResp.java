...
public class GetCallAuctionPartOrderBookResp
    implements Response<
        GetCallAuctionPartOrderBookResp, RestResponse<GetCallAuctionPartOrderBookResp>> {
  ...
  /** common response */
  @JsonIgnore private RestResponse<GetCallAuctionPartOrderBookResp> commonResponse;

  @Override
  public void setCommonResponse(RestResponse<GetCallAuctionPartOrderBookResp> response) {
