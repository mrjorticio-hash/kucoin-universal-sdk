...
public class SpotPublicWsImpl implements SpotPublicWs {
  ...
  public String callAuctionOrderbookLevel50(
    ...
    return this.wsService.subscribe(
        topicPrefix, args,
        CallAuctionOrderbookLevel50Event.CallbackAdapters.of(callback));
  }
  ...
  public String klines(String symbol, String type,
    ...
    return this.wsService.subscribe(topicPrefix, args,
                                    KlinesEvent.CallbackAdapters.of(callback));
  }
  ...
  public String orderbookIncrement(String[] symbol,
    ...
    return this.wsService.subscribe(
        topicPrefix, args,
        OrderbookIncrementEvent.CallbackAdapters.of(callback));
  }
  ...
  public String ticker(String[] symbol, TickerEvent.Callback callback) {
    ...
    return this.wsService.subscribe(topicPrefix, args,
                                    TickerEvent.CallbackAdapters.of(callback));
  }
  ...
  public String trade(String[] symbol, TradeEvent.Callback callback) {
    ...
    return this.wsService.subscribe(topicPrefix, args,
                                    TradeEvent.CallbackAdapters.of(callback));
  }

  public void unSubscribe(String id) { this.wsService.unsubscribe(id); }

  public void start() { this.wsService.start(); }

  public void stop() { this.wsService.stop(); }
}