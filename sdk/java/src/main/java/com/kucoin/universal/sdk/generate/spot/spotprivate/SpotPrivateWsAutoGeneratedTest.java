...
class SpotPrivateWsAutoGeneratedTest {
  ...
  public static void testAccountResponse() throws Exception {
    ...
    WsMessage<AccountEvent> resp =
        mapper.readValue(data, new TypeReference<WsMessage<AccountEvent>>() {});
  }
  ...
  public static void testOrderV1Response() throws Exception {
    ...
    WsMessage<OrderV1Event> resp =
        mapper.readValue(data, new TypeReference<WsMessage<OrderV1Event>>() {});
  }
  ...
  public static void testOrderV2Response() throws Exception {
    ...
    WsMessage<OrderV2Event> resp =
        mapper.readValue(data, new TypeReference<WsMessage<OrderV2Event>>() {});
  }
  ...
  public static void testStopOrderResponse() throws Exception {
    ...
    WsMessage<StopOrderEvent> resp =
        mapper.readValue(data, new TypeReference<WsMessage<StopOrderEvent>>() {});
  }
