...
class SubAccountApiAutoGeneratedTest {
  ...
  public static void testAddSubAccountRequest() throws Exception {
    String data =
        "{\\\"password\\\": \\\"q1234567\\\", \\\"access\\\": \\\"Spot\\\", \\\"subName\\\":"
            + " \\\"subNameTest1\\\", \\\"remarks\\\": \\\"TheRemark\\\"}";
  ...
  public static void testAddSubAccountApiRequest() throws Exception {
    String data =
        "{\\\"subName\\\": \\\"testapi6\\\", \\\"passphrase\\\": \\\"11223344\\\", \\\"remark\\\":"
            + " \\\"TheRemark\\\", \\\"permission\\\": \\\"General,Spot,Futures\\\"}";
  ...
  public static void testModifySubAccountApiRequest() throws Exception {
    String data =
        "{\\\"subName\\\": \\\"testapi6\\\", \\\"apiKey\\\": \\\"670621e3a25958000159c82f\\\","
            + " \\\"passphrase\\\": \\\"11223344\\\", \\\"permission\\\":"
            + " \\\"General,Spot,Futures\\\"}";
  ...
  public static void testDeleteSubAccountApiRequest() throws Exception {
    String data =
        "{\\\"apiKey\\\": \\\"670621e3a25958000159c82f\\\", \\\"subName\\\": \\\"testapi6\\\","
            + " \\\"passphrase\\\": \\\"11223344\\\"}";
