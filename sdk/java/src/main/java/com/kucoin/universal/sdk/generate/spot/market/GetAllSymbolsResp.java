...
public class GetAllSymbolsResp
  ...
  @Override
  public void setCommonResponse(RestResponse<GetAllSymbolsResp> response) {
    this.commonResponse = response;
  }

  @JsonCreator
  public static GetAllSymbolsResp fromJson(List<GetAllSymbolsData> data) {
    // original response
    GetAllSymbolsResp obj = new GetAllSymbolsResp();
    obj.data = data;
    return obj;
  }
}
