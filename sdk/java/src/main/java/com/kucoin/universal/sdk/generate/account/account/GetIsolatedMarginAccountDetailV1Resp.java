...
public class GetIsolatedMarginAccountDetailV1Resp
    implements Response<
        GetIsolatedMarginAccountDetailV1Resp, RestResponse<GetIsolatedMarginAccountDetailV1Resp>> {
  /** Symbol */
  @JsonProperty("symbol")
  ...
  private GetIsolatedMarginAccountDetailV1BaseAsset baseAsset;

  /** */
  @JsonProperty("quoteAsset")
  private GetIsolatedMarginAccountDetailV1QuoteAsset quoteAsset;

  /** common response */
  @JsonIgnore private RestResponse<GetIsolatedMarginAccountDetailV1Resp> commonResponse;

  @Override
  public void setCommonResponse(RestResponse<GetIsolatedMarginAccountDetailV1Resp> response) {
