...
public class GetOrderByClientOidResp
    implements Response<GetOrderByClientOidResp, RestResponse<GetOrderByClientOidResp>> {
  /** Order ID */
  @JsonProperty("id")
  private String id;
  ...
  /** common response */
  @JsonIgnore private RestResponse<GetOrderByClientOidResp> commonResponse;

  @Override
  public void setCommonResponse(RestResponse<GetOrderByClientOidResp> response) {
