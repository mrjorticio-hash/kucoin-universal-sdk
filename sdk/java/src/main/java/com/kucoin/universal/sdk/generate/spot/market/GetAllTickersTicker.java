...
public class GetAllTickersTicker {
   ...
   */
  @JsonProperty("symbolName") private String symbolName;
   ...
   * 24h change rate
   */
  @JsonProperty("changeRate") private String changeRate;

  /**
   * 24h change price
   */
  @JsonProperty("changePrice") private String changePrice;
   ...
   * 24h traded amount
   */
  @JsonProperty("volValue") private String volValue;
   ...
   */
  @JsonProperty("averagePrice") private String averagePrice;

  /**
   * Basic Taker Fee
   */
  @JsonProperty("takerFeeRate") private String takerFeeRate;

  /**
   * Basic Maker Fee
   */
  @JsonProperty("makerFeeRate") private String makerFeeRate;
  ...
  public enum TakerCoefficientEnum {
    ...
    TakerCoefficientEnum(String value) { this.value = value; }
  ...
  public enum MakerCoefficientEnum {
    ...
    MakerCoefficientEnum(String value) { this.value = value; }
