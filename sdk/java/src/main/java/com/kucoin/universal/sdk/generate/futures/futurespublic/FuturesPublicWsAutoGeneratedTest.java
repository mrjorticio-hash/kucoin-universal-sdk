...
class FuturesPublicWsAutoGeneratedTest {
  ...
  public static void testAnnouncementResponse() throws Exception {
    ...
    AnnouncementEvent event = mapper.convertValue(resp.getData(), AnnouncementEvent.class);
  }
  ...
  public static void testExecutionResponse() throws Exception {
    ...
    WsMessage resp = mapper.readValue(data, WsMessage.class);
    ExecutionEvent event = mapper.convertValue(resp.getData(), ExecutionEvent.class);
  }
  ...
  public static void testInstrumentResponse() throws Exception {
    ...
    WsMessage resp = mapper.readValue(data, WsMessage.class);
    InstrumentEvent event = mapper.convertValue(resp.getData(), InstrumentEvent.class);
  }
  ...
  public static void testTickerV1Response() throws Exception {
    ...
    WsMessage resp = mapper.readValue(data, WsMessage.class);
    TickerV1Event event = mapper.convertValue(resp.getData(), TickerV1Event.class);
  }
  ...
  public static void testTickerV2Response() throws Exception {
    ...
    WsMessage resp = mapper.readValue(data, WsMessage.class);
    TickerV2Event event = mapper.convertValue(resp.getData(), TickerV2Event.class);
  }
