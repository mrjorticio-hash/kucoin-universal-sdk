...
class OrderApiAutoGeneratedTest {
  ...
  public static void testCancelOrderByOrderIdRequest() throws Exception {
    String data = "{\"symbol\": \"BTC-USDT\", \"orderId\": \"671663e02188630007e21c9c\"}";
  ...
  public static void testCancelOrderByOrderIdResponse() throws Exception {
    String data = "{\"code\":\"200000\",\"data\":{\"orderId\":\"671663e02188630007e21c9c\"}}";
  ...
  public static void testCancelOrderByClientOidRequest() throws Exception {
    String data = "{\"symbol\": \"BTC-USDT\", \"clientOid\": \"5c52e11203aa677f33e1493fb\"}";
  ...
  public static void testCancelOrderByClientOidResponse() throws Exception {
    String data = "{\"code\":\"200000\",\"data\":{\"clientOid\":\"5c52e11203aa677f33e1493fb\"}}";
  ...
  public static void testGetClosedOrdersRequest() throws Exception {
    String data =
        "{\"symbol\": \"BTC-USDT\", \"tradeType\": \"MARGIN_TRADE\", \"side\": \"buy\", \"type\":"
            + " \"limit\", \"lastId\": 254062248624417, \"limit\": 20, \"startAt\": 1728663338000,"
            + " \"endAt\": 1728692138000}";
  ...
  public static void testGetTradeHistoryRequest() throws Exception {
    String data =
        "{\"symbol\": \"BTC-USDT\", \"tradeType\": \"MARGIN_TRADE\", \"orderId\":"
            + " \"example_string_default_value\", \"side\": \"buy\", \"type\": \"limit\","
            + " \"lastId\": 254062248624417, \"limit\": 100, \"startAt\": 1728663338000, \"endAt\":"
            + " 1728692138000}";
  ...
  public static void testGetOrderByOrderIdRequest() throws Exception {
    String data = "{\"symbol\": \"BTC-USDT\", \"orderId\": \"671667306afcdb000723107f\"}";
  ...
  public static void testAddOrderV1Request() throws Exception {
    String data =
        "{\"type\": \"limit\", \"symbol\": \"BTC-USDT\", \"side\": \"buy\", \"price\": \"50000\","
            + " \"size\": \"0.00001\", \"clientOid\": \"5c52e11203aa677f33e4193fb\", \"remark\":"
            + " \"order remarks\"}";
