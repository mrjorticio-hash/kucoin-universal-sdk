...
class DebitApiAutoGeneratedTest {
  ...
  public static void testBorrowRequest() throws Exception {
    String data =
        "{\\\"currency\\\": \\\"USDT\\\", \\\"size\\\": 10, \\\"timeInForce\\\": \\\"FOK\\\","
            + " \\\"isIsolated\\\": false, \\\"isHf\\\": false}";
  ...
  public static void testGetBorrowHistoryRequest() throws Exception {
    String data =
        "{\\\"currency\\\": \\\"BTC\\\", \\\"isIsolated\\\": true, \\\"symbol\\\":"
            + " \\\"BTC-USDT\\\", \\\"orderNo\\\": \\\"example_string_default_value\\\","
            + " \\\"startTime\\\": 123456, \\\"endTime\\\": 123456, \\\"currentPage\\\": 1,"
            + " \\\"pageSize\\\": 50}";
  ...
  public static void testGetInterestHistoryRequest() throws Exception {
    String data =
        "{\\\"currency\\\": \\\"BTC\\\", \\\"isIsolated\\\": true, \\\"symbol\\\":"
            + " \\\"BTC-USDT\\\", \\\"startTime\\\": 123456, \\\"endTime\\\": 123456,"
