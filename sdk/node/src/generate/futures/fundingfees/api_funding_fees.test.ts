...
describe('Auto Test', () => {
    test('getCurrentFundingRate request test', () => {
        ...
        let req = GetCurrentFundingRateReq.fromJson(data);
    ...
    test('getCurrentFundingRate response test', () => {
        ...
        let resp = GetCurrentFundingRateResp.fromObject(commonResp.data);
    ...
    test('getPublicFundingHistory request test', () => {
        ...
        let req = GetPublicFundingHistoryReq.fromJson(data);
        expect(Object.values(req).every((value) => value === null || value === undefined)).toBe(
            false,
        );
        console.log(req);
    ...
    test('getPublicFundingHistory response test', () => {
        ...
        let commonResp = RestResponse.fromJson(data);
        let resp = GetPublicFundingHistoryResp.fromObject(commonResp.data);
        if (commonResp.data !== null) {
            expect(
                Object.values(resp).every((value) => value === null || value === undefined),
            ).toBe(false);
    ...
    test('getPrivateFundingHistory response test', () => {
        ...
        let commonResp = RestResponse.fromJson(data);
        let resp = GetPrivateFundingHistoryResp.fromObject(commonResp.data);
        if (commonResp.data !== null) {
            expect(
                Object.values(resp).every((value) => value === null || value === undefined),
            ).toBe(false);
