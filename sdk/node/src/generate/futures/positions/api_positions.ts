...
export interface PositionsAPI {
     ...
     * +-----------------------+---------+
     */
    batchSwitchMarginMode(req: BatchSwitchMarginModeReq): Promise<BatchSwitchMarginModeResp>;
     ...
     * +-----------------------+---------+
     */
    getCrossMarginRiskLimit(req: GetCrossMarginRiskLimitReq): Promise<GetCrossMarginRiskLimitResp>;
