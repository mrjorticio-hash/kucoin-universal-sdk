...
export class AddOrderReq implements Serializable {
    /**
     ...
     */
    timeInForce?: AddOrderReq.TimeInForceEnum = AddOrderReq.TimeInForceEnum.GOOD_TILL_CANCELED;
    ...
    static builder(): AddOrderReqBuilder {
        return new AddOrderReqBuilder(new AddOrderReq());
    }
    ...
    static create(data: {
        ...
        if (data.marginMode) {
            ...
            obj.marginMode = AddOrderReq.MarginModeEnum.ISOLATED;
        }
        ...
        if (data.timeInForce) {
            ...
            obj.timeInForce = AddOrderReq.TimeInForceEnum.GOOD_TILL_CANCELED;
        }
        if (data.postOnly) {
    ...
    static fromObject(jsonObject: Object): AddOrderReq {
        return plainToClassFromExist(new AddOrderReq(), jsonObject);
    }
}
...
export class AddOrderReqBuilder {
    constructor(readonly obj: AddOrderReq) {
        this.obj = obj;
    }
    /**
     * Unique order ID created by users to identify their orders. The maximum length cannot exceed 40, e.g. UUID only allows numbers, characters, underline(_), and separator (-).
