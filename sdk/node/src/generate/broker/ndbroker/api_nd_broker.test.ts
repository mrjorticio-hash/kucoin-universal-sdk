...
describe('Auto Test', () => {
    test('submitKYC request test', () => {
        ...
        let req = SubmitKYCReq.fromJson(data);
    ...
    test('submitKYC response test', () => {
        ...
        let resp = SubmitKYCResp.fromObject(commonResp.data);
    ...
    test('getKYCStatus request test', () => {
         ...
         */
        let data = '{"clientUids": "226383154"}';
        let req = GetKYCStatusReq.fromJson(data);
        expect(Object.values(req).every((value) => value === null || value === undefined)).toBe(
            false,
        );
        console.log(req);
    ...
    test('getKYCStatus response test', () => {
        /**
         * getKYCStatus
         * Get KYC Status
         * /api/kyc/ndBroker/proxyClient/status/list
        ...
        let data =
            '{\n    "code": "200000",\n    "data": [\n        {\n            "clientUid": 226383154,\n            "status": "PROCESS",\n            "rejectReason": null\n        }\n    ]\n}';
        let commonResp = RestResponse.fromJson(data);
        let resp = GetKYCStatusResp.fromObject(commonResp.data);
        if (commonResp.data !== null) {
            expect(
                Object.values(resp).every((value) => value === null || value === undefined),
            ).toBe(false);
    ...
    test('getKYCStatusList request test', () => {
        ...
        let req = GetKYCStatusListReq.fromJson(data);
        expect(Object.values(req).every((value) => value === null || value === undefined)).toBe(
            false,
        );
        console.log(req);
    ...
    test('getKYCStatusList response test', () => {
        /**
         * getKYCStatusList
         * Get KYC Status List
         * /api/kyc/ndBroker/proxyClient/status/page
        ...
        let commonResp = RestResponse.fromJson(data);
        let resp = GetKYCStatusListResp.fromObject(commonResp.data);
        if (commonResp.data !== null) {
            expect(
                Object.values(resp).every((value) => value === null || value === undefined),
            ).toBe(false);
