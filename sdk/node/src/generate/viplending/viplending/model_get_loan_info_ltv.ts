...
export class GetLoanInfoLtv implements Serializable {
    /**
     ...
     */
    static fromJson(input: string): GetLoanInfoLtv {
        return this.fromObject(JSON.parse(input));
    }
    /**
     * Create an object from Js Object.
     */
    static fromObject(jsonObject: Object): GetLoanInfoLtv {
        return plainToClassFromExist(new GetLoanInfoLtv(), jsonObject);
    }
}
