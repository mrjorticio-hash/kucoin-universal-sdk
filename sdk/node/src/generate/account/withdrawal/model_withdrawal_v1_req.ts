...
export class WithdrawalV1Req implements Serializable {
    /**
     * currency
     */
    currency: string;
    ...
    static builder(): WithdrawalV1ReqBuilder {
        return new WithdrawalV1ReqBuilder(new WithdrawalV1Req());
    }
     ...
     */
    static fromJson(input: string): WithdrawalV1Req {
        return this.fromObject(JSON.parse(input));
    }
    /**
     * Create an object from Js Object.
     */
    static fromObject(jsonObject: Object): WithdrawalV1Req {
        return plainToClassFromExist(new WithdrawalV1Req(), jsonObject);
    }
}

export class WithdrawalV1ReqBuilder {
    constructor(readonly obj: WithdrawalV1Req) {
        this.obj = obj;
    }
    /**
     * currency
