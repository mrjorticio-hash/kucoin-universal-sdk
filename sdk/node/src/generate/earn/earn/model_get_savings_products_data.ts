...
export class GetSavingsProductsData implements Serializable {
    /**
     * Product ID
     */
    id: string;
     ...
     */
    category: GetSavingsProductsData.CategoryEnum;

    /**
     * Product subtype: TIME (fixed), DEMAND (demand)
     */
    type: GetSavingsProductsData.TypeEnum;
     ...
     */
    status: GetSavingsProductsData.StatusEnum;
     ...
     */
    redeemType: GetSavingsProductsData.RedeemTypeEnum;

    /**
     * Income release type: DAILY (daily release), AFTER (release after product ends)
     */
    incomeReleaseType: GetSavingsProductsData.IncomeReleaseTypeEnum;
     ...
     */
    static fromJson(input: string): GetSavingsProductsData {
        return this.fromObject(JSON.parse(input));
    }
    /**
     * Create an object from Js Object.
     */
    static fromObject(jsonObject: Object): GetSavingsProductsData {
        return plainToClassFromExist(new GetSavingsProductsData(), jsonObject);
    }
}

export namespace GetSavingsProductsData {
