...
export class GetKcsStakingProductsData implements Serializable {
    /**
     * Product ID
     */
    id: string;
     ...
     */
    category: GetKcsStakingProductsData.CategoryEnum;

    /**
     * Product subtype: TIME (fixed), DEMAND (demand)
     */
    type: GetKcsStakingProductsData.TypeEnum;
     ...
     */
    redeemType: GetKcsStakingProductsData.RedeemTypeEnum;
     ...
     */
    static fromJson(input: string): GetKcsStakingProductsData {
        return this.fromObject(JSON.parse(input));
    }
    /**
     * Create an object from Js Object.
     */
    static fromObject(jsonObject: Object): GetKcsStakingProductsData {
        return plainToClassFromExist(new GetKcsStakingProductsData(), jsonObject);
    }
}

export namespace GetKcsStakingProductsData {
