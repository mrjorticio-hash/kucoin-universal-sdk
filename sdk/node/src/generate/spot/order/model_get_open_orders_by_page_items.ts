...
export class GetOpenOrdersByPageItems implements Serializable {
    /**
     ...
     */
    type: GetOpenOrdersByPageItems.TypeEnum;

    /**
     * Buy or sell
     */
    side: GetOpenOrdersByPageItems.SideEnum;
     ...
     */
    stp?: GetOpenOrdersByPageItems.StpEnum;

    /**
     * Time in force
     */
    timeInForce: GetOpenOrdersByPageItems.TimeInForceEnum;
     ...
     */
    static fromJson(input: string): GetOpenOrdersByPageItems {
        return this.fromObject(JSON.parse(input));
    }
    /**
     * Create an object from Js Object.
     */
    static fromObject(jsonObject: Object): GetOpenOrdersByPageItems {
        return plainToClassFromExist(new GetOpenOrdersByPageItems(), jsonObject);
    }
}

export namespace GetOpenOrdersByPageItems {
