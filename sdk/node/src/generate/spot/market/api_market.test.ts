...
describe('Auto Test', () => {
    test('getAnnouncements request test', () => {
        ...
        let req = GetAnnouncementsReq.fromJson(data);
    ...
    test('getAnnouncements response test', () => {
        /**
         * getAnnouncements
         * Get Announcements
         * /api/v3/announcements
    ...
    test('getCurrency response test', () => {
        /**
         * getCurrency
         * Get Currency
         * /api/v3/currencies/{currency}
        ...
        let commonResp = RestResponse.fromJson(data);
        let resp = GetCurrencyResp.fromObject(commonResp.data);
        if (commonResp.data !== null) {
            expect(
                Object.values(resp).every((value) => value === null || value === undefined),
            ).toBe(false);
    ...
    test('getAllCurrencies response test', () => {
        /**
         * getAllCurrencies
         * Get All Currencies
         * /api/v3/currencies
    ...
    test('getAllSymbols request test', () => {
         ...
         * /api/v2/symbols
         */
        let data = '{"market": "ALTS"}';
        let req = GetAllSymbolsReq.fromJson(data);
        expect(Object.values(req).every((value) => value === null || value === undefined)).toBe(
            false,
        );
        console.log(req);
    ...
    test('getFiatPrice request test', () => {
         ...
         * /api/v1/prices
         */
        let data = '{"base": "USD", "currencies": "example_string_default_value"}';
        let req = GetFiatPriceReq.fromJson(data);
        expect(Object.values(req).every((value) => value === null || value === undefined)).toBe(
            false,
        );
        console.log(req);
    ...
    test('getFiatPrice response test', () => {
        /**
         * getFiatPrice
         * Get Fiat Price
         * /api/v1/prices
        ...
        let commonResp = RestResponse.fromJson(data);
        let resp = GetFiatPriceResp.fromObject(commonResp.data);
        if (commonResp.data !== null) {
            expect(
                Object.values(resp).every((value) => value === null || value === undefined),
            ).toBe(false);
    ...
    test('get24hrStats request test', () => {
         ...
         */
        let data = '{"symbol": "BTC-USDT"}';
        let req = Get24hrStatsReq.fromJson(data);
        expect(Object.values(req).every((value) => value === null || value === undefined)).toBe(
            false,
        );
        console.log(req);
    ...
    test('get24hrStats response test', () => {
        ...
        let commonResp = RestResponse.fromJson(data);
        let resp = Get24hrStatsResp.fromObject(commonResp.data);
        if (commonResp.data !== null) {
            expect(
                Object.values(resp).every((value) => value === null || value === undefined),
            ).toBe(false);
    ...
    test('getMarketList response test', () => {
        /**
         * getMarketList
         * Get Market List
         * /api/v1/markets
