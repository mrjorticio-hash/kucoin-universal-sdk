...
import { CallAuctionInfoEvent } from './model_call_auction_info_event';
import { TickerEvent } from './model_ticker_event';
import { SymbolSnapshotEvent } from './model_symbol_snapshot_event';
import { OrderbookLevel1Event } from './model_orderbook_level1_event';
import { AllTickersEvent } from './model_all_tickers_event';
import { OrderbookIncrementEvent } from './model_orderbook_increment_event';
import { TradeEvent } from './model_trade_event';
import { OrderbookLevel50Event } from './model_orderbook_level50_event';
import { MarketSnapshotEvent } from './model_market_snapshot_event';
import { CallAuctionOrderbookLevel50Event } from './model_call_auction_orderbook_level50_event';
import { WsMessage } from '@model/common';

describe('Auto Test', () => {
    test('allTickers response test', () => {
        /**
         * allTickers
         * Get All Tickers
         ...
         */
        let data =
            '{"topic":"/market/ticker:all","type":"message","subject":"BTC-USDT","data":{"bestAsk":"67218.7","bestAskSize":"1.92318539","bestBid":"67218.6","bestBidSize":"0.01045638","price":"67220","sequence":"14691455768","size":"0.00004316","time":1729757723612}}';
        let commonResp = WsMessage.fromJson(data);
        let resp = AllTickersEvent.fromObject(commonResp.data);
        expect(Object.values(resp).every((value) => value === null || value === undefined)).toBe(
            false,
        );
        console.log(resp);
    });
    test('callAuctionInfo response test', () => {
        /**
         * callAuctionInfo
         ...
         */
        let data =
            '{"type":"message","topic":"/callauction/callauctionData:BTC-USDT","subject":"callauction.callauctionData","data":{"symbol":"BTC-USDT","estimatedPrice":"0.17","estimatedSize":"0.03715004","sellOrderRangeLowPrice":"1.788","sellOrderRangeHighPrice":"2.788","buyOrderRangeLowPrice":"1.788","buyOrderRangeHighPrice":"2.788","time":1550653727731}}';
        let commonResp = WsMessage.fromJson(data);
        let resp = CallAuctionInfoEvent.fromObject(commonResp.data);
        expect(Object.values(resp).every((value) => value === null || value === undefined)).toBe(
            false,
        );
        console.log(resp);
    });
    test('callAuctionOrderbookLevel50 response test', () => {
        /**
    ...
    test('klines response test', () => {
         ...
         */
        let data =
            '{"topic":"/market/candles:BTC-USDT_1hour","type":"message","subject":"trade.candles.update","data":{"symbol":"BTC-USDT","candles":["1729839600","67644.9","67437.6","67724.8","67243.8","44.88321441","3027558.991928447"],"time":1729842192785164840}}';
        let commonResp = WsMessage.fromJson(data);
        let resp = KlinesEvent.fromObject(commonResp.data);
        expect(Object.values(resp).every((value) => value === null || value === undefined)).toBe(
            false,
        );
        console.log(resp);
    });
    test('marketSnapshot response test', () => {
        /**
         * marketSnapshot
         * Market Snapshot
        ...
        let commonResp = WsMessage.fromJson(data);
        let resp = MarketSnapshotEvent.fromObject(commonResp.data);
        expect(Object.values(resp).every((value) => value === null || value === undefined)).toBe(
            false,
        );
        console.log(resp);
    ...
    test('orderbookIncrement response test', () => {
         ...
         */
        let data =
            '{"topic":"/market/level2:BTC-USDT","type":"message","subject":"trade.l2update","data":{"changes":{"asks":[["67993.3","1.21427407","14701689783"]],"bids":[]},"sequenceEnd":14701689783,"sequenceStart":14701689783,"symbol":"BTC-USDT","time":1729816425625}}';
        let commonResp = WsMessage.fromJson(data);
        let resp = OrderbookIncrementEvent.fromObject(commonResp.data);
        expect(Object.values(resp).every((value) => value === null || value === undefined)).toBe(
            false,
        );
        console.log(resp);
    });
    test('orderbookLevel1 response test', () => {
        /**
         * orderbookLevel1
         * Orderbook - Level1
        ...
        let commonResp = WsMessage.fromJson(data);
        let resp = OrderbookLevel1Event.fromObject(commonResp.data);
        expect(Object.values(resp).every((value) => value === null || value === undefined)).toBe(
            false,
        );
        console.log(resp);
    ...
    test('orderbookLevel50 response test', () => {
        ...
        let data =
            '{"topic":"/spotMarket/level2Depth50:BTC-USDT","type":"message","subject":"level2","data":{"asks":[["95964.3","0.08168874"],["95967.9","0.00985094"],["95969.9","0.00078081"],["95971.2","0.10016039"],["95971.3","0.12531139"],["95971.7","0.00291"],["95971.9","0.10271829"],["95973.3","0.00021"],["95974.7","0.10271829"],["95976.9","0.03095177"],["95977","0.10271829"],["95978.7","0.00022411"],["95979.1","0.00023017"],["95981","0.00022008"],["95981.2","0.14330324"],["95982.3","0.27922082"],["95982.5","0.02302674"],["95983.8","0.00011035"],["95985","0.00104222"],["95985.1","0.00021808"],["95985.5","0.211127"],["95986.2","0.09690904"],["95986.3","0.31261"],["95986.9","0.09225037"],["95987","0.01042013"],["95990.5","0.12712438"],["95990.6","0.0916115"],["95992.2","0.279"],["95992.7","0.00521084"],["95995.2","0.00033"],["95999.1","0.02973561"],["96001.1","0.083825"],["96002.6","0.01900906"],["96002.7","0.00041665"],["96002.8","0.12531139"],["96002.9","0.279"],["96004.8","0.02081884"],["96006.3","0.00065542"],["96008.5","0.00033166"],["96011","0.08776246"],["96012.5","0.279"],["96013.3","0.00066666"],["96013.9","0.26097183"],["96014","0.01087009"],["96017","0.06248892"],["96017.1","0.20829641"],["96022","0.00107066"],["96022.1","0.279"],["96022.9","0.0006499"],["96024.6","0.00104131"]],"bids":[["95964.2","1.35483359"],["95964.1","0.01117492"],["95962.1","0.0062"],["95961.8","0.03081549"],["95961.7","0.10271829"],["95958.5","0.04681571"],["95958.4","0.05177498"],["95958.2","0.00155911"],["95957.8","0.10271829"],["95954.7","0.16312181"],["95954.6","0.44102109"],["95952.6","0.10271829"],["95951.3","0.0062"],["95951","0.17075141"],["95950.9","0.279"],["95949.5","0.13567811"],["95949.2","0.05177498"],["95948.3","0.10271829"],["95947.2","0.04634798"],["95944.7","0.10271829"],["95944.2","0.05177498"],["95942.3","0.26028569"],["95942.2","0.10271829"],["95940.6","0.12531139"],["95940.2","0.43349327"],["95938.3","0.01041604"],["95937.4","0.04957577"],["95937.2","0.00305"],["95936.3","0.10271829"],["95934","0.05177498"],["95931.9","0.03394093"],["95931.8","0.10271829"],["95930","0.01041814"],["95927.9","0.10271829"],["95927","0.13312774"],["95926.9","0.33077498"],["95924.9","0.10271829"],["95924","0.00180915"],["95923.8","0.00022434"],["95919.6","0.00021854"],["95919.1","0.01471872"],["95919","0.05177498"],["95918.1","0.00001889"],["95917.8","0.1521089"],["95917.5","0.00010962"],["95916.2","0.00021958"],["95915.5","0.12531139"],["95915.3","0.279"],["95913.6","0.01739249"],["95913.5","0.05177498"]],"timestamp":1733124805073}}';
        let commonResp = WsMessage.fromJson(data);
        let resp = OrderbookLevel50Event.fromObject(commonResp.data);
        expect(Object.values(resp).every((value) => value === null || value === undefined)).toBe(
            false,
        );
        console.log(resp);
    ...
    test('orderbookLevel5 response test', () => {
         ...
         */
        let data =
            '{"topic":"/spotMarket/level2Depth5:BTC-USDT","type":"message","subject":"level2","data":{"asks":[["67996.7","1.14213262"],["67996.8","0.21748212"],["67996.9","0.1503747"],["67997","0.11446863"],["67997.1","0.14842782"]],"bids":[["67996.6","0.37969491"],["67995.3","0.20779746"],["67994.5","0.00047785"],["67993.4","0.405"],["67993.3","0.13528566"]],"timestamp":1729822226746}}';
        let commonResp = WsMessage.fromJson(data);
        let resp = OrderbookLevel5Event.fromObject(commonResp.data);
        expect(Object.values(resp).every((value) => value === null || value === undefined)).toBe(
            false,
        );
        console.log(resp);
    ...
    test('ticker response test', () => {
         ...
         */
        let data =
            '{"type":"message","topic":"/market/ticker:BTC-USDT","subject":"trade.ticker","data":{"sequence":"1545896668986","price":"0.08","size":"0.011","bestAsk":"0.08","bestAskSize":"0.18","bestBid":"0.049","bestBidSize":"0.036","Time":1704873323416}}';
        let commonResp = WsMessage.fromJson(data);
        let resp = TickerEvent.fromObject(commonResp.data);
        expect(Object.values(resp).every((value) => value === null || value === undefined)).toBe(
            false,
        );
        console.log(resp);
    });
    test('trade response test', () => {
        /**
         * trade
         * Trade
        ...
        let commonResp = WsMessage.fromJson(data);
        let resp = TradeEvent.fromObject(commonResp.data);
        expect(Object.values(resp).every((value) => value === null || value === undefined)).toBe(
            false,
        );
        console.log(resp);
