...
// GetOpenOrdersByPageItems struct for GetOpenOrdersByPageItems
type GetOpenOrdersByPageItems struct {
...
// NewGetOpenOrdersByPageItems instantiates a new GetOpenOrdersByPageItems object
// This constructor will assign default values to properties that have it defined
func NewGetOpenOrdersByPageItems(id string, symbol string, opType string, Type_ string, side string, price string, size string, funds string, dealSize string, dealFunds string, fee string, feeCurrency string, timeInForce string, postOnly bool, hidden bool, iceberg bool, visibleSize string, cancelAfter int64, channel string, clientOid string, cancelExist bool, createdAt int64, lastUpdatedAt int64, tradeType string, inOrderBook bool, cancelledSize string, cancelledFunds string, remainSize string, remainFunds string, tax string, active bool) *GetOpenOrdersByPageItems {
	this := GetOpenOrdersByPageItems{}
	this.Id = id
	this.Symbol = symbol
	this.OpType = opType
	this.Type = Type_
...
// NewGetOpenOrdersByPageItemsWithDefaults instantiates a new GetOpenOrdersByPageItems object
// This constructor will only assign default values to properties that have it defined,
func NewGetOpenOrdersByPageItemsWithDefaults() *GetOpenOrdersByPageItems {
	this := GetOpenOrdersByPageItems{}
	return &this
}

func (o *GetOpenOrdersByPageItems) ToMap() map[string]interface{} {
