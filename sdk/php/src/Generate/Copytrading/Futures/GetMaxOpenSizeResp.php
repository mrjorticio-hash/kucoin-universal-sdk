...
class GetMaxOpenSizeResp implements Response
{
    /**
    ...
    /**
     * Maximum buy size
     * @var string $maxBuyOpenSize
     * @Type("string")
     * @SerializedName("maxBuyOpenSize")
     */
    public $maxBuyOpenSize;
    /**
     * Maximum buy size
     * @var string $maxSellOpenSize
     * @Type("string")
     * @SerializedName("maxSellOpenSize")
     */
    public $maxSellOpenSize;
