...
class AddOrderTestReq implements Request
{
    /**
...
class AddOrderTestReqBuilder
{
    ...
    /**
     * @param bool $value Optional for type is 'limit' order, Only visible portion of the order is displayed in the order book. When iceberg is chose, choosing postOnly is not allowed.
     * @return self
     */
