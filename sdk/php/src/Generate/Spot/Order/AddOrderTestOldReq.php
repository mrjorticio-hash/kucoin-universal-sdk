...
class AddOrderTestOldReq implements Serializable
{
    /**
    ...
    public static function jsonDeserialize($json, $serializer)
    {
        ...
        return $serializer->deserialize(
            $json,
            AddOrderTestOldReq::class,
            "json"
        );
    }
    /**
     * Creates a new instance of the `AddOrderTestOldReq` class.
     * The builder pattern allows step-by-step construction of a `AddOrderTestOldReq` object.
     * @return AddOrderTestOldReqBuilder
     */
    public static function builder()
    {
        return new AddOrderTestOldReqBuilder(new self());
    }

    /**
     * Creates a new instance of the `AddOrderTestOldReq` class with the given data.
...
{
    /**
     * @var AddOrderTestOldReq $obj
     */
    private $obj;

    public function __construct(AddOrderTestOldReq $obj)
    {
        $this->obj = $obj;
    }
    /**
