...
class AddOrderSyncReq implements Serializable
{
    /**
     ...
     * @return AddOrderSyncReqBuilder
     */
    public static function builder()
    {
        return new AddOrderSyncReqBuilder(new self());
    }
...
{
    /**
     * @var AddOrderSyncReq $obj
     */
    private $obj;

    public function __construct(AddOrderSyncReq $obj)
    {
        $this->obj = $obj;
    }
    /**
