...
class BatchAddOrdersSyncResp implements Response
{
    /**
     *
     * @var BatchAddOrdersSyncData[] $data
     * @Type("array<KuCoin\UniversalSDK\Generate\Spot\Order\BatchAddOrdersSyncData>")
     * @SerializedName("data")
     */
    public $data;
    ...
    public static function jsonDeserialize($json, $serializer)
    {
        ...
        $data = $serializer->deserialize(
            $json,
            "array<KuCoin\UniversalSDK\Generate\Spot\Order\BatchAddOrdersSyncData>",
            "json"
        );
        $obj = new self();
        $obj->data = $data;
