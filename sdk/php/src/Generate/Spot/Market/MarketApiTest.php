...
class MarketApiTest extends TestCase
{
     ...
     */
    public function testGetAnnouncementsRequest()
    {
        $data =
            "{\"currentPage\": 1, \"pageSize\": 50, \"annType\": \"latest-announcements\", \"lang\": \"en_US\", \"startTime\": 1729594043000, \"endTime\": 1729697729000}";
        $req = GetAnnouncementsReq::jsonDeserialize($data, $this->serializer);
     ...
     * /api/v3/announcements
     */
    public function testGetAnnouncementsResponse()
    {
        $data =
        ...
        $resp = GetAnnouncementsResp::jsonDeserialize(
            $respData,
            $this->serializer
        );
     ...
     * /api/v3/currencies
     */
    public function testGetAllCurrenciesRequest()
    {
     ...
     * /api/v3/currencies
     */
    public function testGetAllCurrenciesResponse()
    {
        $data =
        ...
        $commonResp = RestResponse::jsonDeserialize($data, $this->serializer);
        $respData = $this->serializer->serialize($commonResp->data, "json");
        $resp = GetAllCurrenciesResp::jsonDeserialize(
            $respData,
            $this->serializer
        );
        $this->assertTrue($this->hasAnyNoneNull($resp));
    ...
    {
        $data = "{\"market\": \"ALTS\"}";
        $req = GetAllSymbolsReq::jsonDeserialize($data, $this->serializer);
        $this->assertTrue($this->hasAnyNoneNull($req));
        echo $req->jsonSerialize($this->serializer);
    }
    ...
    {
        $data =
            "{\"code\":\"200000\",\"data\":{\"time\":1729172965609,\"sequence\":\"14609309753\",\"price\":\"67269\",\"size\":\"0.000025\",\"bestBid\":\"67267.5\",\"bestBidSize\":\"0.000025\",\"bestAsk\":\"67267.6\",\"bestAskSize\":\"1.24808993\"}}";
        $commonResp = RestResponse::jsonDeserialize($data, $this->serializer);
        $respData = $this->serializer->serialize($commonResp->data, "json");
    ...
    {
        $data =
            "{\"symbol\": \"BTC-USDT\", \"type\": \"1min\", \"startAt\": 1566703297, \"endAt\": 1566789757}";
    ...
    /**
     * getCallAuctionPartOrderBook Request
     * Get Call Auction Part OrderBook
     * /api/v1/market/orderbook/callauction/level2_{size}
     */
    public function testGetCallAuctionPartOrderBookRequest()
    {
        $data = "{\"symbol\": \"BTC-USDT\", \"size\": \"20\"}";
        $req = GetCallAuctionPartOrderBookReq::jsonDeserialize(
            $data,
            $this->serializer
        );
        $this->assertTrue($this->hasAnyNoneNull($req));
    ...
    /**
     * getCallAuctionPartOrderBook Response
     * Get Call Auction Part OrderBook
     * /api/v1/market/orderbook/callauction/level2_{size}
     */
    public function testGetCallAuctionPartOrderBookResponse()
    {
        $data =
            "{\n    \"code\": \"200000\",\n    \"data\": {\n        \"time\": 1729176273859,\n        \"sequence\": \"14610502970\",\n        \"bids\": [\n            [\n                \"66976.4\",\n                \"0.69109872\"\n            ],\n            [\n                \"66976.3\",\n                \"0.14377\"\n            ]\n        ],\n        \"asks\": [\n            [\n                \"66976.5\",\n                \"0.05408199\"\n            ],\n            [\n                \"66976.8\",\n                \"0.0005\"\n            ]\n        ]\n    }\n}";
        $commonResp = RestResponse::jsonDeserialize($data, $this->serializer);
        $respData = $this->serializer->serialize($commonResp->data, "json");
        $resp = GetCallAuctionPartOrderBookResp::jsonDeserialize(
            $respData,
            $this->serializer
        );
        $this->assertTrue($this->hasAnyNoneNull($resp));
    ...
    /**
     * getCallAuctionInfo Request
     * Get Call Auction Info
     * /api/v1/market/callauctionData
     */
    public function testGetCallAuctionInfoRequest()
    {
        $data = "{\"symbol\": \"BTC-USDT\"}";
        $req = GetCallAuctionInfoReq::jsonDeserialize($data, $this->serializer);
        $this->assertTrue($this->hasAnyNoneNull($req));
        echo $req->jsonSerialize($this->serializer);
    }

    /**
     * getCallAuctionInfo Response
     * Get Call Auction Info
     * /api/v1/market/callauctionData
     */
    public function testGetCallAuctionInfoResponse()
    {
        $data =
        ...
        $commonResp = RestResponse::jsonDeserialize($data, $this->serializer);
        $respData = $this->serializer->serialize($commonResp->data, "json");
        $resp = GetCallAuctionInfoResp::jsonDeserialize(
            $respData,
            $this->serializer
        );
        $this->assertTrue($this->hasAnyNoneNull($resp));
    ...
    /**
     * getFiatPrice Request
     * Get Fiat Price
     * /api/v1/prices
     */
    public function testGetFiatPriceRequest()
    {
        $data =
            "{\"base\": \"USD\", \"currencies\": \"example_string_default_value\"}";
        $req = GetFiatPriceReq::jsonDeserialize($data, $this->serializer);
        $this->assertTrue($this->hasAnyNoneNull($req));
        echo $req->jsonSerialize($this->serializer);
    }

    /**
     * getFiatPrice Response
     * Get Fiat Price
     * /api/v1/prices
     */
    public function testGetFiatPriceResponse()
    {
        $data =
        ...
        $commonResp = RestResponse::jsonDeserialize($data, $this->serializer);
        $respData = $this->serializer->serialize($commonResp->data, "json");
        $resp = GetFiatPriceResp::jsonDeserialize($respData, $this->serializer);
        $this->assertTrue($this->hasAnyNoneNull($resp));
        echo $resp->jsonSerialize($this->serializer);
    }
    /**
    ...
    {
        $data = "{\"symbol\": \"BTC-USDT\"}";
        $req = Get24hrStatsReq::jsonDeserialize($data, $this->serializer);
        $this->assertTrue($this->hasAnyNoneNull($req));
        echo $req->jsonSerialize($this->serializer);
    }
    ...
    {
        $data =
            "{\"code\":\"200000\",\"data\":{\"time\":1729175612158,\"symbol\":\"BTC-USDT\",\"buy\":\"66982.4\",\"sell\":\"66982.5\",\"changeRate\":\"-0.0114\",\"changePrice\":\"-778.1\",\"high\":\"68107.7\",\"low\":\"66683.3\",\"vol\":\"1738.02898182\",\"volValue\":\"117321982.415978333\",\"last\":\"66981.5\",\"averagePrice\":\"67281.21437289\",\"takerFeeRate\":\"0.001\",\"makerFeeRate\":\"0.001\",\"takerCoefficient\":\"1\",\"makerCoefficient\":\"1\"}}";
        $commonResp = RestResponse::jsonDeserialize($data, $this->serializer);
        $respData = $this->serializer->serialize($commonResp->data, "json");
     ...
     * /api/v1/markets
     */
    public function testGetMarketListRequest()
    {
        $this->assertTrue(true);
    }

    /**
     * getMarketList Response
     * Get Market List
     * /api/v1/markets
     */
    public function testGetMarketListResponse()
    {
        $data =
            "{\"code\":\"200000\",\"data\":[\"USDS\",\"TON\",\"AI\",\"DePIN\",\"PoW\",\"BRC-20\",\"ETF\",\"KCS\",\"Meme\",\"Solana\",\"FIAT\",\"VR&AR\",\"DeFi\",\"Polkadot\",\"BTC\",\"ALTS\",\"Layer 1\"]}";
        $commonResp = RestResponse::jsonDeserialize($data, $this->serializer);
        $respData = $this->serializer->serialize($commonResp->data, "json");
        $resp = GetMarketListResp::jsonDeserialize(
            $respData,
            $this->serializer
        );
        $this->assertTrue($this->hasAnyNoneNull($resp));
     ...
     * /api/v1/my-ip
     */
    public function testGetClientIPAddressRequest()
    {
        $this->assertTrue(true);
    }

    /**
     * getClientIPAddress Response
     * Get Client IP Address
     * /api/v1/my-ip
     */
    public function testGetClientIPAddressResponse()
    {
        $data = "{\"code\":\"200000\",\"data\":\"20.***.***.128\"}";
        $commonResp = RestResponse::jsonDeserialize($data, $this->serializer);
        $respData = $this->serializer->serialize($commonResp->data, "json");
        $resp = GetClientIPAddressResp::jsonDeserialize(
            $respData,
            $this->serializer
        );
        $this->assertTrue($this->hasAnyNoneNull($resp));
    ...
    {
        $data =
            "{\"code\":\"200000\",\"data\":{\"status\":\"open\",\"msg\":\"\"}}";
        $commonResp = RestResponse::jsonDeserialize($data, $this->serializer);
        $respData = $this->serializer->serialize($commonResp->data, "json");
