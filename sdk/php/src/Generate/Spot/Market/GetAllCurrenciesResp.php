...
class GetAllCurrenciesResp implements Response
{
    /**
     *
     * @var GetAllCurrenciesData[] $data
     * @Type("array<KuCoin\UniversalSDK\Generate\Spot\Market\GetAllCurrenciesData>")
     * @SerializedName("data")
     */
    public $data;
    ...
    public static function jsonDeserialize($json, $serializer)
    {
        $data = $serializer->deserialize(
            $json,
            "array<KuCoin\UniversalSDK\Generate\Spot\Market\GetAllCurrenciesData>",
            "json"
        );
        $obj = new self();
        $obj->data = $data;
