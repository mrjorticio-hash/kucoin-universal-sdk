...
class GetAllCurrenciesDataChains implements Serializable
{
    /**
     ...
     * @var string|null $depositFeeRate
     * @Type("string")
     * @SerializedName("depositFeeRate")
     */
    public $depositFeeRate;
    /**
     * Withdraw max. fee (some currencies have this param; the default is empty)
     * @var string|null $withdrawMaxFee
     * @Type("string")
     * @SerializedName("withdrawMaxFee")
     */
    public $withdrawMaxFee;
    /**
     *
     * @var string|null $depositTierFee
     * @Type("string")
     * @SerializedName("depositTierFee")
     */
    public $depositTierFee;
    ...
    public static function jsonDeserialize($json, $serializer)
    {
        ...
        return $serializer->deserialize(
            $json,
            GetAllCurrenciesDataChains::class,
            "json"
        );
    }
}
