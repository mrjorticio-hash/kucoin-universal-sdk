...
class SpotPublicWsTest extends TestCase
{
    /**
    ...
    public function testAllTickersResponse()
    {
        ...
        $resp = AllTickersEvent::jsonDeserialize(
    ...
    public function testCallAuctionInfoResponse()
    {
        ...
        $commonResp = WsMessage::jsonDeserialize($data, $this->serializer);
        $resp = CallAuctionInfoEvent::jsonDeserialize(
            $this->serializer->serialize($commonResp->rawData, "json"),
            $this->serializer
        );
        $result = $this->hasAnyNoneNull($resp);
    ...
    public function testCallAuctionOrderbookLevel50Response()
    {
        ...
        $commonResp = WsMessage::jsonDeserialize($data, $this->serializer);
        $resp = CallAuctionOrderbookLevel50Event::jsonDeserialize(
            $this->serializer->serialize($commonResp->rawData, "json"),
            $this->serializer
        );
        $result = $this->hasAnyNoneNull($resp);
    ...
    public function testMarketSnapshotResponse()
    {
        ...
        $commonResp = WsMessage::jsonDeserialize($data, $this->serializer);
        $resp = MarketSnapshotEvent::jsonDeserialize(
            $this->serializer->serialize($commonResp->rawData, "json"),
            $this->serializer
        );
        $result = $this->hasAnyNoneNull($resp);
    ...
    public function testOrderbookLevel1Response()
    {
        ...
        $commonResp = WsMessage::jsonDeserialize($data, $this->serializer);
        $resp = OrderbookLevel1Event::jsonDeserialize(
            $this->serializer->serialize($commonResp->rawData, "json"),
            $this->serializer
        );
        $result = $this->hasAnyNoneNull($resp);
    ...
    public function testTickerResponse()
    {
        ...
        $commonResp = WsMessage::jsonDeserialize($data, $this->serializer);
        $resp = TickerEvent::jsonDeserialize(
            $this->serializer->serialize($commonResp->rawData, "json"),
            $this->serializer
        );
        $result = $this->hasAnyNoneNull($resp);
    ...
    public function testTradeResponse()
    {
        ...
        $commonResp = WsMessage::jsonDeserialize($data, $this->serializer);
        $resp = TradeEvent::jsonDeserialize(
            $this->serializer->serialize($commonResp->rawData, "json"),
            $this->serializer
        );
        $result = $this->hasAnyNoneNull($resp);
