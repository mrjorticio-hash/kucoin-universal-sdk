...
class GetStakingProductsResp implements Response
{
    /**
     *
     * @var GetStakingProductsData[] $data
     * @Type("array<KuCoin\UniversalSDK\Generate\Earn\Earn\GetStakingProductsData>")
     * @SerializedName("data")
     */
    public $data;
    ...
    public static function jsonDeserialize($json, $serializer)
    {
        ...
        $data = $serializer->deserialize(
            $json,
            "array<KuCoin\UniversalSDK\Generate\Earn\Earn\GetStakingProductsData>",
            "json"
        );
        $obj = new self();
        $obj->data = $data;
