...
class GetKYCStatusResp implements Response
{
    /**
     *
     * @var GetKYCStatusData[] $data
     * @Type("array<KuCoin\UniversalSDK\Generate\Broker\Ndbroker\GetKYCStatusData>")
     * @SerializedName("data")
     */
    public $data;
    ...
    public static function jsonDeserialize($json, $serializer)
    {
        ...
        $data = $serializer->deserialize(
            $json,
            "array<KuCoin\UniversalSDK\Generate\Broker\Ndbroker\GetKYCStatusData>",
            "json"
        );
        $obj = new self();
        $obj->data = $data;
