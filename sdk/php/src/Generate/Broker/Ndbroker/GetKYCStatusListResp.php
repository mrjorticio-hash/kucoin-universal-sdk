...
class GetKYCStatusListResp implements Response
{
    /**
     *
     * @var int $currentPage
    ...
    /**
     *
     * @var GetKYCStatusListItems[] $items
     * @Type("array<KuCoin\UniversalSDK\Generate\Broker\Ndbroker\GetKYCStatusListItems>")
