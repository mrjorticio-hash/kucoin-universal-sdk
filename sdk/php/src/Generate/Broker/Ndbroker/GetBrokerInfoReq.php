...
class GetBrokerInfoReq implements Serializable
{
    /**
    ...
    public static function jsonDeserialize($json, $serializer)
    {
        ...
        return $serializer->deserialize($json, GetBrokerInfoReq::class, "json");
    }
    /**
     ...
     * @return GetBrokerInfoReqBuilder
     */
    public static function builder()
    {
        return new GetBrokerInfoReqBuilder(new self());
    }
...
{
    /**
     * @var GetBrokerInfoReq $obj
     */
    private $obj;

    public function __construct(GetBrokerInfoReq $obj)
    {
        $this->obj = $obj;
    }
    /**
