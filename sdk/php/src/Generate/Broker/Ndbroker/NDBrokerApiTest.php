...
class NDBrokerApiTest extends TestCase
{
     ...
     * /api/kyc/ndBroker/proxyClient/submit
     */
    public function testSubmitKYCResponse()
    {
        ...
        $respData = $commonResp->data
            ...
            : null;
        $resp = SubmitKYCResp::jsonDeserialize($respData, $this->serializer);
        $commonResp->data
     ...
     */
    public function testGetKYCStatusRequest()
    {
        $data = "{\"clientUids\": \"226383154\"}";
        $req = GetKYCStatusReq::jsonDeserialize($data, $this->serializer);
        $this->assertTrue($this->hasAnyNoneNull($req));
        echo $req->jsonSerialize($this->serializer);
    }
     ...
     * /api/kyc/ndBroker/proxyClient/status/list
     */
    public function testGetKYCStatusResponse()
    {
        $data =
            "{\n    \"code\": \"200000\",\n    \"data\": [\n        {\n            \"clientUid\": 226383154,\n            \"status\": \"PROCESS\",\n            \"rejectReason\": null\n        }\n    ]\n}";
        $commonResp = RestResponse::jsonDeserialize($data, $this->serializer);
        $respData = $commonResp->data
            ? $this->serializer->serialize($commonResp->data, "json")
            : null;
        $resp = GetKYCStatusResp::jsonDeserialize($respData, $this->serializer);
        $commonResp->data
            ? $this->assertTrue($this->hasAnyNoneNull($resp))
            : $this->assertTrue(true);
        echo $resp->jsonSerialize($this->serializer);
    ...
    /**
     * getKYCStatusList Request
     * Get KYC Status List
     * /api/kyc/ndBroker/proxyClient/status/page
     */
    public function testGetKYCStatusListRequest()
    {
        $data = "{\"pageNumber\": 1, \"pageSize\": 100}";
        $req = GetKYCStatusListReq::jsonDeserialize($data, $this->serializer);
        $this->assertTrue($this->hasAnyNoneNull($req));
        echo $req->jsonSerialize($this->serializer);
    }

    /**
     * getKYCStatusList Response
     * Get KYC Status List
     * /api/kyc/ndBroker/proxyClient/status/page
     */
    public function testGetKYCStatusListResponse()
    {
        $data =
        ...
        $respData = $commonResp->data
            ? $this->serializer->serialize($commonResp->data, "json")
            : null;
        $resp = GetKYCStatusListResp::jsonDeserialize(
            $respData,
            $this->serializer
        );
        $commonResp->data
