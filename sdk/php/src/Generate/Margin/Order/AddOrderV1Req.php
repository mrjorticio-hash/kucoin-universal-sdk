...
class AddOrderV1Req implements Request
{
    /**
    ...
    {
        return $serializer->deserialize($json, AddOrderV1Req::class, "json");
    }
    /**
     ...
     * @return AddOrderV1ReqBuilder
     */
    public static function builder()
    {
        return new AddOrderV1ReqBuilder(new self());
    }
...
{
    /**
     * @var AddOrderV1Req $obj
     */
    private $obj;

    public function __construct(AddOrderV1Req $obj)
    {
        $this->obj = $obj;
    }
    /**
