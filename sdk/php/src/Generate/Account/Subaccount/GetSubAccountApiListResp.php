...
class GetSubAccountApiListResp implements Response
{
    /**
     *
     * @var GetSubAccountApiListData[] $data
     * @Type("array<KuCoin\UniversalSDK\Generate\Account\Subaccount\GetSubAccountApiListData>")
     * @SerializedName("data")
     */
    public $data;
    ...
    public static function jsonDeserialize($json, $serializer)
    {
        ...
        $data = $serializer->deserialize(
            $json,
            "array<KuCoin\UniversalSDK\Generate\Account\Subaccount\GetSubAccountApiListData>",
            "json"
        );
        $obj = new self();
        $obj->data = $data;
