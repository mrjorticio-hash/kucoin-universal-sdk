...
class GetSpotSubAccountListV2Resp implements Response
{
    /**
     *
     * @var int $currentPage
    ...
    /**
     *
     * @var GetSpotSubAccountListV2Items[] $items
     * @Type("array<KuCoin\UniversalSDK\Generate\Account\Subaccount\GetSpotSubAccountListV2Items>")
