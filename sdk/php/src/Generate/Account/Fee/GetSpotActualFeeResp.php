...
class GetSpotActualFeeResp implements Response
{
    /**
     *
     * @var GetSpotActualFeeData[] $data
     * @Type("array<KuCoin\UniversalSDK\Generate\Account\Fee\GetSpotActualFeeData>")
     * @SerializedName("data")
     */
    public $data;
    ...
    public static function jsonDeserialize($json, $serializer)
    {
        ...
        $data = $serializer->deserialize(
            $json,
            "array<KuCoin\UniversalSDK\Generate\Account\Fee\GetSpotActualFeeData>",
            "json"
        );
        $obj = new self();
        $obj->data = $data;
