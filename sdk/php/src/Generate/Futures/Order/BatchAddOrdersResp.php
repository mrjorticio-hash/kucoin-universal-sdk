...
class BatchAddOrdersResp implements Response
{
    /**
     *
     * @var BatchAddOrdersData[] $data
     * @Type("array<KuCoin\UniversalSDK\Generate\Futures\Order\BatchAddOrdersData>")
     * @SerializedName("data")
     */
    public $data;
    ...
    public static function jsonDeserialize($json, $serializer)
    {
        $data = $serializer->deserialize(
            $json,
            "array<KuCoin\UniversalSDK\Generate\Futures\Order\BatchAddOrdersData>",
            "json"
        );
        $obj = new self();
        $obj->data = $data;
