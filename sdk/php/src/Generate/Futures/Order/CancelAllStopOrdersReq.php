...
class CancelAllStopOrdersReq implements Request
{
    /**
     ...
     * @return CancelAllStopOrdersReqBuilder
     */
    public static function builder()
    {
        return new CancelAllStopOrdersReqBuilder(new self());
    }
...
{
    /**
     * @var CancelAllStopOrdersReq $obj
     */
    private $obj;

    public function __construct(CancelAllStopOrdersReq $obj)
    {
        $this->obj = $obj;
    }
    /**
     * @param string $value Cancel all limit orders for a specific contract only,  If not specified, all the limit orders will be deleted, Please refer to [Get Symbol endpoint: symbol](https://www.kucoin.com/docs-new/api-3470220)
     * @return self
     */
