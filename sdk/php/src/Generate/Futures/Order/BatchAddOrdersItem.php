...
class BatchAddOrdersItem implements Request
{
    /**
...
class BatchAddOrdersItemBuilder
{
    ...
    /**
     * @param string $value Symbol of the contract, Please refer to [Get Symbol endpoint: symbol](https://www.kucoin.com/docs-new/api-221752070)
     * @return self
     */
    ...
    /**
     * @param string $value Optional for type is 'limit' order, The maximum visible size of an iceberg order. please place order in size (lots), The units of qty (base currency) and valueQty (value) are not supported.
     * @return self
     */
