...
class GetOpenOrderValueReq implements Serializable
{
    /**
     ...
     * @return GetOpenOrderValueReqBuilder
     */
    public static function builder()
    {
        return new GetOpenOrderValueReqBuilder(new self());
    }
...
{
    /**
     * @var GetOpenOrderValueReq $obj
     */
    private $obj;

    public function __construct(GetOpenOrderValueReq $obj)
    {
        $this->obj = $obj;
    }
    /**
