...
class GetMarginModeReq implements Serializable
{
    /**
    ...
    {
        return $serializer->deserialize($json, GetMarginModeReq::class, "json");
    }
    /**
     ...
     * @return GetMarginModeReqBuilder
     */
    public static function builder()
    {
        return new GetMarginModeReqBuilder(new self());
    }
...
{
    /**
     * @var GetMarginModeReq $obj
     */
    private $obj;

    public function __construct(GetMarginModeReq $obj)
    {
        $this->obj = $obj;
    }
    /**
