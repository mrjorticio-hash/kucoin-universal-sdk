...
class GetAllSymbolsResp implements Response
{
    /**
     * List of all contracts
     * @var GetAllSymbolsData[] $data
     * @Type("array<KuCoin\UniversalSDK\Generate\Futures\Market\GetAllSymbolsData>")
     * @SerializedName("data")
     */
    public $data;
    ...
    public static function jsonDeserialize($json, $serializer)
    {
        ...
        $data = $serializer->deserialize(
            $json,
            "array<KuCoin\UniversalSDK\Generate\Futures\Market\GetAllSymbolsData>",
            "json"
        );
        $obj = new self();
        $obj->data = $data;
