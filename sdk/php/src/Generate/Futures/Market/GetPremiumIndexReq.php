...
class GetPremiumIndexReqBuilder
{
    ...
    /**
     * @param string $value Symbol of the contract. Please refer to [Get Symbol endpoint: premiumsSymbol1M, premiumsSymbol8H](https://www.kucoin.com/docs-new/api-3470220)
     * @return self
     */
